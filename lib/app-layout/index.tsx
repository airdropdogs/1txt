...
const SIDEBAR_WIDTH_KEY = '1txt_sidebar_width';
...
export class AppLayout extends Component<Props, State> {
  ...
  handleResizeStart = (event: React.MouseEvent<HTMLDivElement>) => {
  ...
  render = () => {
    ...
    // Only honor the user-resized width on wide desktop screens. On phones
    // (single-column) and in focus mode, CSS owns the width — inline styles
    // would otherwise override the focus-mode `width: 0` collapse and the
    // small-screen full-width layout.
    const sidebarStyle =
