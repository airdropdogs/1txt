...
export class NoteEditor extends Component<Props> {
  ...
  render() {
    ...
    let editorComponent;
    if (editorViewMode === 'source' || !note.systemTags.includes('markdown')) {
      editorComponent = (
        <NoteDetail
      ...
      editorComponent = <WysiwygEditor noteId={noteId} />;
    } else {
      editorComponent = <NotePreview noteId={noteId} />;
    }
...
const mapStateToProps: S.MapState<StateProps> = (state) => ({
  ...
  editorViewMode: state.ui.editorViewMode,
