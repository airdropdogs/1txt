...
module.exports = function (window) {
    ...
    function () {
      dialog.showMessageBox(window, {
        ...
        message:
          ...
          `${path.basename(file)}`,
        detail:
          'For help, please open an issue at https://github.com/airdropdogs/1txt/issues and attach your logs.',
      });
    };
  ...
  const onError = (error) =>
    dialog.showMessageBox(window, {
      ...
      detail:
        'Please open an issue at https://github.com/airdropdogs/1txt/issues with the error details below:' +
        '\n\n' +
        error.stack +
        '\n\n' +
        'System info: ' +
  ...
  try {
    ...
    const dst = path.join(desktop, `1txt-${timestamp}.zip`);
