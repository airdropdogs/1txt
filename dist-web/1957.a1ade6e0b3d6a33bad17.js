/*! For license information please see 1957.a1ade6e0b3d6a33bad17.js.LICENSE.txt */
'use strict';
  ...
  [1957],
  {
    11957: (e, t, n) => {
      ...
      ((g = d || (d = {})).MIN_VALUE = -2147483648),
        ...
        (b.is = function (e) {
          ...
          return (
            ...
            (v.is(t.targetSelectionRange) ||
              ot.undefined(t.targetSelectionRange)) &&
            (v.is(t.originSelectionRange) ||
        ...
        (W.is = function (e) {
          ...
          return (
            ...
            (ot.undefined(n.relatedInformation) ||
              ot.typedArray(n.relatedInformation, M.is))
          );
        }),
        ...
        (z.is = function (e) {
          var t = e;
          return ot.objectLiteral(t) && ot.string(t.newText) && v.is(t.range);
        }),
      ...
      !(function () {
        ...
        (Ee.is = function (e) {
          var t = e;
          return t && ot.string(t.newText) && v.is(t.insert) && v.is(t.replace);
        }),
        ((xe = Ce || (Ce = {})).asIs = 1),
        ...
        Tt = class {
          ...
          provideDocumentFormattingEdits(e, t, n) {
            ...
            return this._worker(r).then((e) =>
              e.format(r.toString(), null, Mt(t)).then((e) => {
        ...
        Dt = class {
          ...
          provideDocumentRangeFormattingEdits(e, t, n, r) {
            ...
            return this._worker(i).then((e) =>
              e.format(i.toString(), ht(t), Mt(n)).then((e) => {
                if (e && 0 !== e.length) return e.map(vt);
              })
            );
          }
        ...
        return (
          (function () {
            ...
            Nt(n),
              ...
              r.hovers &&
                n.push(c.languages.registerHoverProvider(t, new mt(i))),
              r.documentHighlights &&
                n.push(
                  c.languages.registerDocumentHighlightProvider(t, new kt(i))
                ),
              r.definitions &&
                n.push(c.languages.registerDefinitionProvider(t, new yt(i))),
              r.references &&
                n.push(c.languages.registerReferenceProvider(t, new Ct(i))),
              r.documentSymbols &&
                n.push(
                  c.languages.registerDocumentSymbolProvider(t, new At(i))
                ),
              r.rename &&
                n.push(c.languages.registerRenameProvider(t, new xt(i))),
              r.colors &&
                n.push(c.languages.registerColorProvider(t, new Pt(i))),
              r.foldingRanges &&
                n.push(c.languages.registerFoldingRangeProvider(t, new Ft(i))),
              r.diagnostics && n.push(new ct(t, i, e.onDidChange)),
              r.selectionRanges &&
                n.push(
