(() => {
  ...
  (() => {
      ...
      constructor() {
        (this.listeners = []),
          (this.unexpectedErrorHandler = function (e) {
            setTimeout(() => {
              if (e.stack) {
                if (o.isErrorNoTelemetry(e))
                  throw new o(e.message + '\n\n' + e.stack);
    ...
    function t(t) {
      var n;
      (n = t) instanceof s ||
        (n instanceof Error && n.name === r && n.message === r) ||
    ...
    class p {
      ...
      deleteAndLeak(e) {
        e && this._toDispose.has(e) && (this._toDispose.delete(e), m(e, null));
      }
    }
    p.DISABLE_DISPOSED_WARNING = !1;
    class b {
      constructor() {
        (this._store = new p()), c(this), m(this._store, this);
      }
      dispose() {
    ...
    (b.None = Object.freeze({ dispose() {} })), Symbol.iterator;
    class _ {
      constructor(e) {
        (this.element = e),
    ...
    const y =
      globalThis.performance && 'function' == typeof globalThis.performance.now;
    class C {
      static create(e) {
        return new C(e);
      }
    ...
    !(function (e) {
      ...
      function i(e, t, n) {
        return r(
          (n, i = null, r) => e((e) => t(e) && n.call(i, e), null, r),
          n
        );
      }
      function r(e, t) {
        ...
        return null == t || t.add(i), i.event;
      }
      function s(e, t, n = 100, i = !1, r = !1, s, o) {
        let a,
          l,
          u,
          h,
        ...
        (e.any = function (...e) {
          return (t, n = null, i) => {
            return (
              ...
              (s = i) instanceof Array ? s.push(r) : s && s.add(r),
              r
            );
            var r, s;
          };
        ...
        (e.fromObservableLight = function (e) {
          return (t, n, i) => {
            ...
            const o = {
              ...
              endUpdate() {
                r--, 0 === r && (e.reportChanges(), s && ((s = !1), t.call(n)));
              },
      ...
      check(e, t) {
        ...
        if (
          ...
          for (const [t, n] of this._stacks)
            (!e || i < n) && ((e = t), (i = n));
          console.warn(
            `[${this.name}] potential listener LEAK detected, having ${t} listeners already. MOST frequent listener (${i}):`
          ),
            console.warn(e);
        }
        return () => {
    ...
    class E {
      static create() {
        var e;
        return new E(null !== (e = new Error().stack) && void 0 !== e ? e : '');
      }
      constructor(e) {
        this.value = e;
      }
    ...
    class R {
                ...
                null !==
                  (i =
                    null === (n = this._options) || void 0 === n
                      ? void 0
                      : n.leakWarningThreshold) && void 0 !== i
                  ? i
                  : -1
              )
            : void 0),
          (this._perfMon = (
            null === (r = this._options) || void 0 === r ? void 0 : r._profName
          )
        ...
        return (
          (null !== (e = this._event) && void 0 !== e) ||
            (this._event = (e, t, n) => {
              ...
              return (
                n instanceof p ? n.add(h) : Array.isArray(n) && n.push(h), h
              );
            }),
          this._event
        );
      ...
      _removeListener(e) {
        ...
        this._size--, (s[o] = void 0);
        const a = this._deliveryQueue.current === this;
        if (2 * this._size <= s.length) {
          let e = 0;
      ...
      fire(e) {
        ...
        if (
          ...
          null === (i = this._perfMon) || void 0 === i || i.start(this._size),
          this._listeners)
        )
          if (this._listeners instanceof S) this._deliver(this._listeners, e);
          else {
    ...
    const Y = globalThis;
    let X;
    void 0 !== Y.vscode && void 0 !== Y.vscode.process
      ? (X = Y.vscode.process)
      : void 0 !== I &&
        'string' ==
          typeof (null === (T = null == I ? void 0 : I.versions) || void 0 === T
            ? void 0
            : T.node) &&
        (X = I);
    const Z =
        'string' ==
        typeof (null === (O = null == X ? void 0 : X.versions) || void 0 === O
          ? void 0
          : O.electron),
      ee = Z && 'renderer' === (null == X ? void 0 : X.type);
    if ('object' == typeof X) {
      (K = 'win32' === X.platform),
        (q = 'darwin' === X.platform),
        (V = 'linux' === X.platform),
        (B = V && !!X.env.SNAP && !!X.env.SNAP_REVISION),
        (W = Z),
        ($ = !!X.env.CI || !!X.env.BUILD_ARTIFACTSTAGINGDIRECTORY),
        (D = P),
        (G = P);
      ...
      if (e)
        try {
          ...
          (D = t.locale),
            (Q = t.osLocale),
            (G = n || P),
            (J = t._translationsConfigFile);
        } catch (e) {}
      U = !0;
    } else
      'object' != typeof navigator || ee
        ? console.error('Unable to resolve platform.')
        : ((F = navigator.userAgent),
          (K = F.indexOf('Windows') >= 0),
          (q = F.indexOf('Macintosh') >= 0),
          (z =
          ...
          (V = F.indexOf('Linux') >= 0),
          (j = (null == F ? void 0 : F.indexOf('Mobi')) >= 0),
          (H = !0),
          (D = void k(0, '_') || P),
          (G = D),
          (Q = navigator.language));
    let te = 0;
    q ? (te = 1) : K ? (te = 3) : V && (te = 2);
    const ne = K,
      ie = q,
      re = (H && 'function' == typeof Y.importScripts && Y.origin, F),
      se = 'function' == typeof Y.postMessage && !Y.importScripts;
    (() => {
      if (se) {
        const e = [];
    ...
    const oe = !!(re && re.indexOf('Chrome') >= 0);
    re && re.indexOf('Firefox'),
      !oe && re && re.indexOf('Safari'),
      re && re.indexOf('Edg/'),
    ...
    (le = pe),
      (pe.ambiguousCharacterData = new ae(() =>
        JSON.parse(
      ...
      (pe.cache = new (class {
        constructor(e, t = JSON.stringify) {
          (this.fn = e),
            (this._computeKey = t),
        ...
        const i = le.ambiguousCharacterData.value;
        let r,
          s = e.filter((e) => !e.startsWith('_') && e in i);
        0 === s.length && (s = ['_default']);
        for (const e of s) r = n(r, t(i[e]));
        const o = (function (e, t) {
          const n = new Map(e);
          for (const [e, i] of t) n.set(e, i);
          return n;
        })(t(i._common), r);
        return new le(o);
      })),
      (pe._locales = new ae(() =>
        Object.keys(le.ambiguousCharacterData.value).filter(
          (e) => !e.startsWith('_')
        )
      ));
    class be {
      ...
      static getData() {
        return (
          this._data || (this._data = new Set(be.getRawData())), this._data
        );
      }
      static isInvisibleCharacter(e) {
        return be.getData().has(e);
      }
    ...
    class we {
      ...
      sendMessage(e, t) {
        ...
        return new Promise((i, r) => {
          (this._pendingReplies[n] = { resolve: i, reject: r }),
            this._send(new _e(this._workerId, n, e, t));
        });
      }
      listen(e, t) {
        let n = null;
        const i = new R({
          onWillAddFirstListener: () => {
            (n = String(++this._lastSentReq)),
              ...
              this._send(new ye(this._workerId, n, e, t));
          },
          onDidRemoveLastListener: () => {
            this._pendingEmitters.delete(n),
              this._send(new Le(this._workerId, n)),
              (n = null);
          },
        });
        return i.event;
      ...
      _handleRequestMessage(e) {
        ...
        this._handler.handleMessage(e.method, e.args).then(
          (e) => {
            this._send(new ve(this._workerId, t, e, void 0));
          },
          (e) => {
            e.detail instanceof Error && (e.detail = i(e.detail)),
              this._send(new ve(this._workerId, t, void 0, i(e)));
          }
        );
      }
    ...
    function Ne(e) {
      return 'o' === e[0] && 'n' === e[1] && ue(e.charCodeAt(2));
    }
    function Ee(e) {
      return /^onDynamic/.test(e) && ue(e.charCodeAt(9));
    }
    class Se {
      constructor(e, t) {
      ...
      initialize(e, t, n, i) {
        ...
        return this._requestHandlerFactory
          ? ((this._requestHandler = this._requestHandlerFactory(r)),
            Promise.resolve(x(this._requestHandler)))
          : (t &&
    ...
    function xe(e, t) {
      t = Ae(149417, t);
      for (let n = 0, i = e.length; n < i; n++) t = Ae(e.charCodeAt(n), t);
      return t;
    }
    ...
    function ke(e, t = 0, n = e.byteLength, i = 0) {
    ...
    class Oe {
      ...
      _wrapUp() {
        (this._buff[this._buffLen++] = 128),
          ke(this._buff, this._buffLen),
          this._buffLen > 56 && (this._step(), ke(this._buff));
      ...
      _step() {
        ...
        for (let t = 0; t < 80; t++)
          t < 20
            ...
            (r = (Me(s, 5) + n + u + i + e.getUint32(4 * t, !1)) & 4294967295),
            (u = l),
            (l = a),
            (a = Me(o, 30)),
            (o = s),
    ...
    function Pe(e, t, n) {
      return new qe(new Ie(e), new Ie(t)).ComputeDiff(n).changes;
    }
    class De {
      static Assert(e, t) {
    ...
    class qe {
      constructor(e, t, n = null) {
        ...
        const [i, r, s] = qe._getElements(e),
          [o, a, l] = qe._getElements(t);
      ...
      static _getElements(e) {
        ...
        if (qe._isStringArray(t)) {
          const e = new Int32Array(t.length);
          for (let n = 0, i = t.length; n < i; n++) e[n] = xe(t[n], 0);
          return [t, e, !0];
        }
      ...
      ElementsAreStrictEqual(e, t) {
        return (
          ...
          qe._getStrictElement(this._originalSequence, e) ===
            qe._getStrictElement(this._modifiedSequence, t)
        );
      }
      ...
      ComputeDiffRecursive(e, t, n, i, r) {
        ...
        if (!r[0]) {
          ...
          return (
            (o = r[0]
              ? [new Re(l + 1, t - (l + 1) + 1, u + 1, i - (u + 1) + 1)]
              : this.ComputeDiffRecursive(l + 1, t, u + 1, i, r)),
            this.ConcatenateChanges(s, o)
          );
        }
        return [new Re(e, t - e + 1, n, i - n + 1)];
      }
      WALKTRACE(e, t, n, i, r, s, o, a, l, u, h, c, d, m, g, f, p, b) {
        let _ = null,
          v = null,
          y = new Ke(),
          C = t,
        ...
        do {
          ...
          t === C || (t < L && l[t - 1] < l[t + 1])
            ? ((m = (h = l[t + 1]) - w - i),
              h < N && y.MarkNextChange(),
              (N = h),
              y.AddModifiedElement(h + 1, m),
              (w = t + 1 - e))
            : ((m = (h = l[t - 1] + 1) - w - i),
              h < N && y.MarkNextChange(),
              (N = h - 1),
              y.AddOriginalElement(h, m + 1),
              (w = t - 1 - e)),
            E >= 0 &&
              ((e = (l = this.m_forwardHistory[E])[0]),
              (C = 1),
              (L = l.length - 1));
        } while (--E >= -1);
        if (((_ = y.getReverseChanges()), b[0])) {
          let e = d[0] + 1,
            t = f[0] + 1;
          ...
          do {
            ...
            e === C || (e < L && u[e - 1] >= u[e + 1])
              ? ((m = (h = u[e + 1] - 1) - w - a),
                h > N && y.MarkNextChange(),
                (N = h + 1),
                y.AddOriginalElement(h + 1, m + 1),
                (w = e + 1 - r))
              : ((m = (h = u[e - 1]) - w - a),
                h > N && y.MarkNextChange(),
                (N = h),
                y.AddModifiedElement(h + 1, m + 1),
                (w = e - 1 - r)),
              E >= 0 &&
                ((r = (u = this.m_reverseHistory[E])[0]),
                (C = 1),
                (L = u.length - 1));
          } while (--E >= -1);
          v = y.getChanges();
      ...
      ComputeRecursionPoint(e, t, n, i, r, s, o) {
        ...
        for (let L = 1; L <= m / 2 + 1; L++) {
          let m = 0,
            w = 0;
          (u = this.ClipDiagonalBound(b - L, L, b, g)),
          ...
          if (
            ...
            return (
              ...
              N > 0 && L <= 1448
                ...
                : (e++, n++, [new Re(e, t - e + 1, n, i - n + 1)])
            );
          (c = this.ClipDiagonalBound(_ - L, L, _, g)),
            (d = this.ClipDiagonalBound(_ + L, L, _, g));
          for (let m = c; m <= d; m += 2) {
            (a =
              m === c || (m < d && p[m - 1] >= p[m + 1])
                ? p[m + 1] - 1
            ...
            if (((p[m] = a), C && Math.abs(m - b) <= L && a <= f[m]))
              return (
                (r[0] = a),
                (s[0] = l),
                g >= f[m] && L <= 1448
      ...
      ConcatenateChanges(e, t) {
        ...
        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
          ...
          return (
            Fe.Copy(e, 0, i, 0, e.length - 1),
            (i[e.length - 1] = n[0]),
            Fe.Copy(t, 1, i, e.length, t.length - 1),
            i
          );
        }
        {
          ...
          return (
            Fe.Copy(e, 0, n, 0, e.length),
            Fe.Copy(t, 0, n, e.length, t.length),
            n
          );
        }
      }
    ...
    var Ve = n(538);
    let Be;
    const Ue = globalThis.vscode;
    if (void 0 !== Ue && void 0 !== Ue.process) {
      const e = Ue.process;
      Be = {
        get platform() {
          return e.platform;
      ...
      Be =
        void 0 !== Ve
          ? {
              ...
              cwd: () => Ve.env.VSCODE_CWD || Ve.cwd(),
            }
          : {
              get platform() {
                return ne ? 'win32' : ie ? 'darwin' : 'linux';
              },
              get arch() {},
              get env() {
                return {};
        ...
        if (i(l)) {
          if (o === u - 1 || 1 === a);
            ...
            if (
              r.length < 2 ||
              2 !== s ||
              r.charCodeAt(r.length - 1) !== $e ||
              r.charCodeAt(r.length - 2) !== $e
            ) {
              if (r.length > 2) {
    ...
    function it(e, t) {
      !(function (e, t) {
        if (null === e || 'object' != typeof e)
          throw new Je('pathObject', 'Object', e);
      })(t);
    ...
    const rt = {
        resolve(...e) {
          ...
          for (let r = e.length - 1; r >= -1; r--) {
            let s;
            if (r >= 0) {
              if (((s = e[r]), Ye(s, 'path'), 0 === s.length)) continue;
            } else
              0 === t.length
                ? (s = He())
                : ((s = We[`=${t}`] || He()),
            ...
            if (1 === o) Ze(h) && ((a = 1), (u = !0));
              ...
              if (((u = !0), Ze(s.charCodeAt(1)))) {
                let e = 2,
                  t = e;
                for (; e < o && !Ze(s.charCodeAt(e)); ) e++;
                if (e < o && e !== t) {
                  const n = s.slice(t, e);
                  for (t = e; e < o && Ze(s.charCodeAt(e)); ) e++;
                  if (e < o && e !== t) {
                    for (t = e; e < o && !Ze(s.charCodeAt(e)); ) e++;
                    (e !== o && e === t) ||
                      ((l = `\\\\${n}\\${s.slice(t, e)}`), (a = e));
        ...
        normalize(e) {
          ...
          if (1 === t) return et(s) ? '\\' : e;
          if (Ze(s))
            if (((r = !0), Ze(e.charCodeAt(1)))) {
              let r = 2,
                s = r;
              for (; r < t && !Ze(e.charCodeAt(r)); ) r++;
              if (r < t && r !== s) {
                const o = e.slice(s, r);
                for (s = r; r < t && Ze(e.charCodeAt(r)); ) r++;
                if (r < t && r !== s) {
                  for (s = r; r < t && !Ze(e.charCodeAt(r)); ) r++;
            ...
            tt(s) &&
              ...
              ((n = e.slice(0, 2)),
              (i = 2),
              t > 2 && Ze(e.charCodeAt(2)) && ((r = !0), (i = 3)));
          let o = i < t ? nt(e.slice(i), !r, '\\', Ze) : '';
          return (
            0 !== o.length || r || (o = '.'),
            o.length > 0 && Ze(e.charCodeAt(t - 1)) && (o += '\\'),
        ...
        isAbsolute(e) {
          ...
          return (
            Ze(n) ||
            (t > 2 && tt(n) && e.charCodeAt(1) === Qe && Ze(e.charCodeAt(2)))
          );
        },
        join(...e) {
          ...
          let i = !0,
            r = 0;
          if ('string' == typeof n && Ze(n.charCodeAt(0))) {
            ++r;
            const e = n.length;
            e > 1 &&
              Ze(n.charCodeAt(1)) &&
              (++r, e > 2 && (Ze(n.charCodeAt(2)) ? ++r : (i = !1)));
          }
          if (i) {
            for (; r < t.length && Ze(t.charCodeAt(r)); ) r++;
            r >= 2 && (t = `\\${t.slice(r)}`);
          }
          return rt.normalize(t);
        },
        relative(e, t) {
          if ((Ye(e, 'from'), Ye(t, 'to'), e === t)) return '';
          const n = rt.resolve(e),
            i = rt.resolve(t);
          if (n === i) return '';
          if ((e = n.toLowerCase()) === (t = i.toLowerCase())) return '';
          let r = 0;
          for (; r < e.length && e.charCodeAt(r) === Ge; ) r++;
          let s = e.length;
          for (; s - 1 > r && e.charCodeAt(s - 1) === Ge; ) s--;
          const o = s - r;
          let a = 0;
          for (; a < t.length && t.charCodeAt(a) === Ge; ) a++;
          let l = t.length;
          for (; l - 1 > a && t.charCodeAt(l - 1) === Ge; ) l--;
          const u = l - a,
            h = o < u ? o : u;
          let c = -1,
            d = 0;
          ...
          if (d !== h) {
            ...
            if (u > h) {
              if (t.charCodeAt(a + d) === Ge) return i.slice(a + d + 1);
              if (2 === d) return i.slice(a + d);
            }
            o > h &&
              (e.charCodeAt(r + d) === Ge ? (c = d) : 2 === d && (c = 3)),
              -1 === c && (c = 0);
          }
          let m = '';
          for (d = r + c + 1; d <= s; ++d)
            (d !== s && e.charCodeAt(d) !== Ge) ||
              (m += 0 === m.length ? '..' : '\\..');
          return (
            (a += c),
            m.length > 0
              ? `${m}${i.slice(a, l)}`
              : (i.charCodeAt(a) === Ge && ++a, i.slice(a, l))
          );
        },
        toNamespacedPath(e) {
          ...
          if (t.charCodeAt(0) === Ge) {
            if (t.charCodeAt(1) === Ge) {
              ...
              if (63 !== e && e !== $e) return `\\\\?\\UNC\\${t.slice(2)}`;
            }
          } else if (
            tt(t.charCodeAt(0)) &&
            t.charCodeAt(1) === Qe &&
        ...
        dirname(e) {
          ...
          if (1 === t) return Ze(r) ? e : '.';
          if (Ze(r)) {
            if (((n = i = 1), Ze(e.charCodeAt(1)))) {
              let r = 2,
                s = r;
              for (; r < t && !Ze(e.charCodeAt(r)); ) r++;
              if (r < t && r !== s) {
            ...
            tt(r) &&
              e.charCodeAt(1) === Qe &&
              ((n = t > 2 && Ze(e.charCodeAt(2)) ? 3 : 2), (i = n));
          let s = -1,
            o = !0;
          for (let n = t - 1; n >= i; --n)
            if (Ze(e.charCodeAt(n))) {
              if (!o) {
                s = n;
                break;
              }
        ...
        parse(e) {
          ...
          if (1 === n)
            return Ze(r)
              ...
              : ((t.base = t.name = e), t);
          if (Ze(r)) {
            if (((i = 1), Ze(e.charCodeAt(1)))) {
              let t = 2,
                r = t;
              for (; t < n && !Ze(e.charCodeAt(t)); ) t++;
              if (t < n && t !== r) {
                for (r = t; t < n && Ze(e.charCodeAt(t)); ) t++;
                if (t < n && t !== r) {
                  for (r = t; t < n && !Ze(e.charCodeAt(t)); ) t++;
                  t === n ? (i = t) : t !== r && (i = t + 1);
                }
          ...
          } else if (tt(r) && e.charCodeAt(1) === Qe) {
            if (n <= 2) return (t.root = t.dir = e), t;
            if (((i = 2), Ze(e.charCodeAt(2)))) {
      ...
      ot = {
        resolve(...e) {
          ...
          for (let i = e.length - 1; i >= -1 && !n; i--) {
            ...
            Ye(r, 'path'),
              0 !== r.length &&
                ((t = `${r}/${t}`), (n = r.charCodeAt(0) === je));
          }
          return (t = nt(t, !n, '/', et)), n ? `/${t}` : t.length > 0 ? t : '.';
        },
        normalize(e) {
          if ((Ye(e, 'path'), 0 === e.length)) return '.';
          const t = e.charCodeAt(0) === je,
            n = e.charCodeAt(e.length - 1) === je;
          return 0 === (e = nt(e, !t, '/', et)).length
            ? t
              ? '/'
              : n
                ? './'
        ...
        isAbsolute: (e) => (
          Ye(e, 'path'), e.length > 0 && e.charCodeAt(0) === je
        ),
        join(...e) {
          if (0 === e.length) return '.';
          let t;
          ...
          return void 0 === t ? '.' : ot.normalize(t);
        },
        relative(e, t) {
          if ((Ye(e, 'from'), Ye(t, 'to'), e === t)) return '';
          if ((e = ot.resolve(e)) === (t = ot.resolve(t))) return '';
          const n = e.length,
            i = n - 1,
            r = t.length - 1,
            s = i < r ? i : r;
          ...
          if (a === s)
            if (r > s) {
              if (t.charCodeAt(1 + a) === je) return t.slice(1 + a + 1);
              if (0 === a) return t.slice(1 + a);
            } else
              i > s &&
                (e.charCodeAt(1 + a) === je ? (o = a) : 0 === a && (o = 0));
          let l = '';
          for (a = 1 + o + 1; a <= n; ++a)
            (a !== n && e.charCodeAt(a) !== je) ||
              (l += 0 === l.length ? '..' : '/..');
    ...
    (ot.win32 = rt.win32 = rt),
      (ot.posix = rt.posix = ot),
      Xe ? rt.normalize : ot.normalize,
      Xe ? rt.resolve : ot.resolve,
      Xe ? rt.relative : ot.relative,
      Xe ? rt.dirname : ot.dirname,
      Xe ? rt.basename : ot.basename,
      Xe ? rt.extname : ot.extname,
      Xe ? rt.sep : ot.sep;
    const at = /^\w[\w\d+.-]*$/,
      lt = /^\//,
      ut = /^\/\//,
    ...
    class mt {
      ...
      with(e) {
        ...
        return (
          void 0 === t ? (t = this.scheme) : null === t && (t = ht),
          void 0 === n ? (n = this.authority) : null === n && (n = ht),
          void 0 === i ? (i = this.path) : null === i && (i = ht),
          void 0 === r ? (r = this.query) : null === r && (r = ht),
          void 0 === s ? (s = this.fragment) : null === s && (s = ht),
          t === this.scheme &&
          n === this.authority &&
          i === this.path &&
          r === this.query &&
      ...
      static parse(e, t = !1) {
        ...
        return n
          ...
          : new ft(ht, ht, ht, ht, ht);
      }
      static file(e) {
        let t = ht;
        if ((ne && (e = e.replace(/\\/g, ct)), e[0] === ct && e[1] === ct)) {
          const n = e.indexOf(ct, 2);
          -1 === n
            ? ((t = e.substring(2)), (e = ct))
            : ((t = e.substring(2, n)), (e = e.substring(n) || ct));
        }
        return new ft('file', t, e, ht, ht);
      }
      static from(e, t) {
        return new ft(e.scheme, e.authority, e.path, e.query, e.fragment, t);
      }
      static joinPath(e, ...t) {
        if (!e.path)
          throw new Error(
        ...
        if (e) {
          if (e instanceof mt) return e;
          {
            ...
            return (
              ...
              (i._fsPath =
                e._sep === gt && null !== (n = e.fsPath) && void 0 !== n
                  ? n
                  : null),
              i
            );
    ...
    function bt(e, t, n) {
      ...
      for (let s = 0; s < e.length; s++) {
        ...
        if (
          ...
          -1 !== r && ((i += encodeURIComponent(e.substring(r, s))), (r = -1)),
            void 0 !== i && (i += e.charAt(s));
        else {
          void 0 === i && (i = e.substr(0, s));
          const t = pt[o];
          void 0 !== t
            ? (-1 !== r &&
    ...
    function _t(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        const i = e.charCodeAt(n);
        35 === i || 63 === i
          ? (void 0 === t && (t = e.substr(0, n)), (t += pt[i]))
          : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
      ...
      if (
        ...
        if (-1 !== e) {
          ...
          (s = s.substr(e + 1)),
            ...
            -1 === e
              ? (i += n(t, !1, !1))
              : ((i += n(t.substr(0, e), !1, !1)),
                (i += ':'),
                (i += n(t.substr(e + 1), !1, !0))),
            (i += '@');
        }
        (s = s.toLowerCase()),
          (e = s.lastIndexOf(':')),
          -1 === e
            ? (i += n(s, !1, !0))
            : ((i += n(s.substr(0, e), !1, !0)), (i += s.substr(e)));
      }
      if (o) {
    ...
    function wt(e) {
      return e.match(Lt) ? e.replace(Lt, (e) => Ct(e)) : e;
    }
    class Nt {
      constructor(e, t) {
    ...
    class Et {
      ...
      static intersectRanges(e, t) {
        ...
        return (
          ...
          n > r || (n === r && i > s) ? null : new Et(n, i, r, s)
        );
      }
      equalsRange(e) {
    ...
    class xt {
      ...
      filter(e) {
        return new xt((t) => this.iterate((n) => !e(n) || t(n)));
      }
      map(e) {
        return new xt((t) => this.iterate((n) => t(e(n))));
      }
      findLast(e) {
        let t;
      ...
      findLastMaxBy(e) {
        ...
        return (
          this.iterate(
            (i) => ((n || St.isGreaterThan(e(i, t))) && ((n = !1), (t = i)), !0)
          ),
          t
        );
      }
    ...
    class Tt {
      ...
      getPrefixSum(e) {
        return e < 0 ? 0 : ((e = kt(e)), this._getPrefixSum(e));
      }
      _getPrefixSum(e) {
        ...
        for (const e of t)
          this._acceptDeleteRange(e.range),
            this._acceptInsertText(
              new Nt(e.range.startLineNumber, e.range.startColumn),
              e.text
            );
    ...
    function Kt(e, t, n, i, r) {
      if (((t = Dt(t)), r || (r = u.first(Ft)), n.length > r.maxLen)) {
        let s = e - r.maxLen / 2;
        return (
          s < 0 ? (s = 0) : (i += s),
          Kt(e, t, (n = n.substring(s, e + r.maxLen / 2)), i, r)
        );
      }
      const s = Date.now(),
        o = e - 1 - i;
    ...
    Ft.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
    class Vt {
      constructor(e) {
        const t = Mt(e);
        ...
        for (let r = 1, s = e.getLineCount(); r <= s; r++) {
          ...
          for (; a < o; ) {
            ...
            if (13 === h) {
              ...
              1 === t && (i.push(zt._createLink(n, s, r, l, a)), (e = !0));
            } else if (12 === h) {
              let t;
              91 === o ? ((d = !0), (t = 0)) : (t = n.get(o)),
                1 === t ? (e = !0) : (h = 13);
            } else (h = t.nextState(h, o)), 0 === h && (e = !0);
            e && ((h = 1), (c = !1), (d = !1), (g = !1), (l = a + 1), (u = o)),
              a++;
          }
          13 === h && i.push(zt._createLink(n, s, r, l, o));
        }
        return i;
      }
    }
    ...
    !(function (e) {
      (e.isCancellationToken = function (t) {
        ...
        (e.None = Object.freeze({
          ...
          onCancellationRequested: L.None,
        })),
    ...
    const Yt = new Jt(),
      ...
      on = [],
      an = [];
    for (let e = 0; e <= 193; e++) on[e] = -1;
    for (let e = 0; e <= 132; e++) an[e] = -1;
    var ln;
    !(function () {
      const e = '',
        t = [
      ...
      for (const e of t) {
        ...
        if (
          ...
          Yt.define(o, a), Xt.define(o, h || a), Zt.define(o, c || h || a);
        }
        l && (en[l] = o), u && (tn[u] = o);
      }
      an[3] = 46;
    ...
    const dn = {
      add: cn('add', 6e4),
      plus: cn('plus', 6e4),
      gistNew: cn('gist-new', 6e4),
      repoCreate: cn('repo-create', 6e4),
      lightbulb: cn('lightbulb', 60001),
      lightBulb: cn('light-bulb', 60001),
      repo: cn('repo', 60002),
      repoDelete: cn('repo-delete', 60002),
      gistFork: cn('gist-fork', 60003),
      repoForked: cn('repo-forked', 60003),
      gitPullRequest: cn('git-pull-request', 60004),
      gitPullRequestAbandoned: cn('git-pull-request-abandoned', 60004),
      recordKeys: cn('record-keys', 60005),
      keyboard: cn('keyboard', 60005),
      tag: cn('tag', 60006),
      gitPullRequestLabel: cn('git-pull-request-label', 60006),
      tagAdd: cn('tag-add', 60006),
      tagRemove: cn('tag-remove', 60006),
      person: cn('person', 60007),
      personFollow: cn('person-follow', 60007),
      personOutline: cn('person-outline', 60007),
      personFilled: cn('person-filled', 60007),
      gitBranch: cn('git-branch', 60008),
      gitBranchCreate: cn('git-branch-create', 60008),
      gitBranchDelete: cn('git-branch-delete', 60008),
      sourceControl: cn('source-control', 60008),
      mirror: cn('mirror', 60009),
      mirrorPublic: cn('mirror-public', 60009),
      star: cn('star', 60010),
      starAdd: cn('star-add', 60010),
      starDelete: cn('star-delete', 60010),
      starEmpty: cn('star-empty', 60010),
      comment: cn('comment', 60011),
      commentAdd: cn('comment-add', 60011),
      alert: cn('alert', 60012),
      warning: cn('warning', 60012),
      search: cn('search', 60013),
      searchSave: cn('search-save', 60013),
      logOut: cn('log-out', 60014),
      signOut: cn('sign-out', 60014),
      logIn: cn('log-in', 60015),
      signIn: cn('sign-in', 60015),
      eye: cn('eye', 60016),
      eyeUnwatch: cn('eye-unwatch', 60016),
      eyeWatch: cn('eye-watch', 60016),
      circleFilled: cn('circle-filled', 60017),
      primitiveDot: cn('primitive-dot', 60017),
      closeDirty: cn('close-dirty', 60017),
      debugBreakpoint: cn('debug-breakpoint', 60017),
      debugBreakpointDisabled: cn('debug-breakpoint-disabled', 60017),
      debugHint: cn('debug-hint', 60017),
      terminalDecorationSuccess: cn('terminal-decoration-success', 60017),
      primitiveSquare: cn('primitive-square', 60018),
      edit: cn('edit', 60019),
      pencil: cn('pencil', 60019),
      info: cn('info', 60020),
      issueOpened: cn('issue-opened', 60020),
      gistPrivate: cn('gist-private', 60021),
      gitForkPrivate: cn('git-fork-private', 60021),
      lock: cn('lock', 60021),
      mirrorPrivate: cn('mirror-private', 60021),
      close: cn('close', 60022),
      removeClose: cn('remove-close', 60022),
      x: cn('x', 60022),
      repoSync: cn('repo-sync', 60023),
      sync: cn('sync', 60023),
      clone: cn('clone', 60024),
      desktopDownload: cn('desktop-download', 60024),
      beaker: cn('beaker', 60025),
      microscope: cn('microscope', 60025),
      vm: cn('vm', 60026),
      deviceDesktop: cn('device-desktop', 60026),
      file: cn('file', 60027),
      fileText: cn('file-text', 60027),
      more: cn('more', 60028),
      ellipsis: cn('ellipsis', 60028),
      kebabHorizontal: cn('kebab-horizontal', 60028),
      mailReply: cn('mail-reply', 60029),
      reply: cn('reply', 60029),
      organization: cn('organization', 60030),
      organizationFilled: cn('organization-filled', 60030),
      organizationOutline: cn('organization-outline', 60030),
      newFile: cn('new-file', 60031),
      fileAdd: cn('file-add', 60031),
      newFolder: cn('new-folder', 60032),
      fileDirectoryCreate: cn('file-directory-create', 60032),
      trash: cn('trash', 60033),
      trashcan: cn('trashcan', 60033),
      history: cn('history', 60034),
      clock: cn('clock', 60034),
      folder: cn('folder', 60035),
      fileDirectory: cn('file-directory', 60035),
      symbolFolder: cn('symbol-folder', 60035),
      logoGithub: cn('logo-github', 60036),
      markGithub: cn('mark-github', 60036),
      github: cn('github', 60036),
      terminal: cn('terminal', 60037),
      console: cn('console', 60037),
      repl: cn('repl', 60037),
      zap: cn('zap', 60038),
      symbolEvent: cn('symbol-event', 60038),
      error: cn('error', 60039),
      stop: cn('stop', 60039),
      variable: cn('variable', 60040),
      symbolVariable: cn('symbol-variable', 60040),
      array: cn('array', 60042),
      symbolArray: cn('symbol-array', 60042),
      symbolModule: cn('symbol-module', 60043),
      symbolPackage: cn('symbol-package', 60043),
      symbolNamespace: cn('symbol-namespace', 60043),
      symbolObject: cn('symbol-object', 60043),
      symbolMethod: cn('symbol-method', 60044),
      symbolFunction: cn('symbol-function', 60044),
      symbolConstructor: cn('symbol-constructor', 60044),
      symbolBoolean: cn('symbol-boolean', 60047),
      symbolNull: cn('symbol-null', 60047),
      symbolNumeric: cn('symbol-numeric', 60048),
      symbolNumber: cn('symbol-number', 60048),
      symbolStructure: cn('symbol-structure', 60049),
      symbolStruct: cn('symbol-struct', 60049),
      symbolParameter: cn('symbol-parameter', 60050),
      symbolTypeParameter: cn('symbol-type-parameter', 60050),
      symbolKey: cn('symbol-key', 60051),
      symbolText: cn('symbol-text', 60051),
      symbolReference: cn('symbol-reference', 60052),
      goToFile: cn('go-to-file', 60052),
      symbolEnum: cn('symbol-enum', 60053),
      symbolValue: cn('symbol-value', 60053),
      symbolRuler: cn('symbol-ruler', 60054),
      symbolUnit: cn('symbol-unit', 60054),
      activateBreakpoints: cn('activate-breakpoints', 60055),
      archive: cn('archive', 60056),
      arrowBoth: cn('arrow-both', 60057),
      arrowDown: cn('arrow-down', 60058),
      arrowLeft: cn('arrow-left', 60059),
      arrowRight: cn('arrow-right', 60060),
      arrowSmallDown: cn('arrow-small-down', 60061),
      arrowSmallLeft: cn('arrow-small-left', 60062),
      arrowSmallRight: cn('arrow-small-right', 60063),
      arrowSmallUp: cn('arrow-small-up', 60064),
      arrowUp: cn('arrow-up', 60065),
      bell: cn('bell', 60066),
      bold: cn('bold', 60067),
      book: cn('book', 60068),
      bookmark: cn('bookmark', 60069),
      debugBreakpointConditionalUnverified: cn(
        'debug-breakpoint-conditional-unverified',
        60070
      ),
      debugBreakpointConditional: cn('debug-breakpoint-conditional', 60071),
      debugBreakpointConditionalDisabled: cn(
        'debug-breakpoint-conditional-disabled',
        60071
      ),
      debugBreakpointDataUnverified: cn(
        'debug-breakpoint-data-unverified',
        60072
      ),
      debugBreakpointData: cn('debug-breakpoint-data', 60073),
      debugBreakpointDataDisabled: cn('debug-breakpoint-data-disabled', 60073),
      debugBreakpointLogUnverified: cn(
        'debug-breakpoint-log-unverified',
        60074
      ),
      debugBreakpointLog: cn('debug-breakpoint-log', 60075),
      debugBreakpointLogDisabled: cn('debug-breakpoint-log-disabled', 60075),
      briefcase: cn('briefcase', 60076),
      broadcast: cn('broadcast', 60077),
      browser: cn('browser', 60078),
      bug: cn('bug', 60079),
      calendar: cn('calendar', 60080),
      caseSensitive: cn('case-sensitive', 60081),
      check: cn('check', 60082),
      checklist: cn('checklist', 60083),
      chevronDown: cn('chevron-down', 60084),
      chevronLeft: cn('chevron-left', 60085),
      chevronRight: cn('chevron-right', 60086),
      chevronUp: cn('chevron-up', 60087),
      chromeClose: cn('chrome-close', 60088),
      chromeMaximize: cn('chrome-maximize', 60089),
      chromeMinimize: cn('chrome-minimize', 60090),
      chromeRestore: cn('chrome-restore', 60091),
      circleOutline: cn('circle-outline', 60092),
      circle: cn('circle', 60092),
      debugBreakpointUnverified: cn('debug-breakpoint-unverified', 60092),
      terminalDecorationIncomplete: cn('terminal-decoration-incomplete', 60092),
      circleSlash: cn('circle-slash', 60093),
      circuitBoard: cn('circuit-board', 60094),
      clearAll: cn('clear-all', 60095),
      clippy: cn('clippy', 60096),
      closeAll: cn('close-all', 60097),
      cloudDownload: cn('cloud-download', 60098),
      cloudUpload: cn('cloud-upload', 60099),
      code: cn('code', 60100),
      collapseAll: cn('collapse-all', 60101),
      colorMode: cn('color-mode', 60102),
      commentDiscussion: cn('comment-discussion', 60103),
      creditCard: cn('credit-card', 60105),
      dash: cn('dash', 60108),
      dashboard: cn('dashboard', 60109),
      database: cn('database', 60110),
      debugContinue: cn('debug-continue', 60111),
      debugDisconnect: cn('debug-disconnect', 60112),
      debugPause: cn('debug-pause', 60113),
      debugRestart: cn('debug-restart', 60114),
      debugStart: cn('debug-start', 60115),
      debugStepInto: cn('debug-step-into', 60116),
      debugStepOut: cn('debug-step-out', 60117),
      debugStepOver: cn('debug-step-over', 60118),
      debugStop: cn('debug-stop', 60119),
      debug: cn('debug', 60120),
      deviceCameraVideo: cn('device-camera-video', 60121),
      deviceCamera: cn('device-camera', 60122),
      deviceMobile: cn('device-mobile', 60123),
      diffAdded: cn('diff-added', 60124),
      diffIgnored: cn('diff-ignored', 60125),
      diffModified: cn('diff-modified', 60126),
      diffRemoved: cn('diff-removed', 60127),
      diffRenamed: cn('diff-renamed', 60128),
      diff: cn('diff', 60129),
      diffSidebyside: cn('diff-sidebyside', 60129),
      discard: cn('discard', 60130),
      editorLayout: cn('editor-layout', 60131),
      emptyWindow: cn('empty-window', 60132),
      exclude: cn('exclude', 60133),
      extensions: cn('extensions', 60134),
      eyeClosed: cn('eye-closed', 60135),
      fileBinary: cn('file-binary', 60136),
      fileCode: cn('file-code', 60137),
      fileMedia: cn('file-media', 60138),
      filePdf: cn('file-pdf', 60139),
      fileSubmodule: cn('file-submodule', 60140),
      fileSymlinkDirectory: cn('file-symlink-directory', 60141),
      fileSymlinkFile: cn('file-symlink-file', 60142),
      fileZip: cn('file-zip', 60143),
      files: cn('files', 60144),
      filter: cn('filter', 60145),
      flame: cn('flame', 60146),
      foldDown: cn('fold-down', 60147),
      foldUp: cn('fold-up', 60148),
      fold: cn('fold', 60149),
      folderActive: cn('folder-active', 60150),
      folderOpened: cn('folder-opened', 60151),
      gear: cn('gear', 60152),
      gift: cn('gift', 60153),
      gistSecret: cn('gist-secret', 60154),
      gist: cn('gist', 60155),
      gitCommit: cn('git-commit', 60156),
      gitCompare: cn('git-compare', 60157),
      compareChanges: cn('compare-changes', 60157),
      gitMerge: cn('git-merge', 60158),
      githubAction: cn('github-action', 60159),
      githubAlt: cn('github-alt', 60160),
      globe: cn('globe', 60161),
      grabber: cn('grabber', 60162),
      graph: cn('graph', 60163),
      gripper: cn('gripper', 60164),
      heart: cn('heart', 60165),
      home: cn('home', 60166),
      horizontalRule: cn('horizontal-rule', 60167),
      hubot: cn('hubot', 60168),
      inbox: cn('inbox', 60169),
      issueReopened: cn('issue-reopened', 60171),
      issues: cn('issues', 60172),
      italic: cn('italic', 60173),
      jersey: cn('jersey', 60174),
      json: cn('json', 60175),
      kebabVertical: cn('kebab-vertical', 60176),
      key: cn('key', 60177),
      law: cn('law', 60178),
      lightbulbAutofix: cn('lightbulb-autofix', 60179),
      linkExternal: cn('link-external', 60180),
      link: cn('link', 60181),
      listOrdered: cn('list-ordered', 60182),
      listUnordered: cn('list-unordered', 60183),
      liveShare: cn('live-share', 60184),
      loading: cn('loading', 60185),
      location: cn('location', 60186),
      mailRead: cn('mail-read', 60187),
      mail: cn('mail', 60188),
      markdown: cn('markdown', 60189),
      megaphone: cn('megaphone', 60190),
      mention: cn('mention', 60191),
      milestone: cn('milestone', 60192),
      gitPullRequestMilestone: cn('git-pull-request-milestone', 60192),
      mortarBoard: cn('mortar-board', 60193),
      move: cn('move', 60194),
      multipleWindows: cn('multiple-windows', 60195),
      mute: cn('mute', 60196),
      noNewline: cn('no-newline', 60197),
      note: cn('note', 60198),
      octoface: cn('octoface', 60199),
      openPreview: cn('open-preview', 60200),
      package: cn('package', 60201),
      paintcan: cn('paintcan', 60202),
      pin: cn('pin', 60203),
      play: cn('play', 60204),
      run: cn('run', 60204),
      plug: cn('plug', 60205),
      preserveCase: cn('preserve-case', 60206),
      preview: cn('preview', 60207),
      project: cn('project', 60208),
      pulse: cn('pulse', 60209),
      question: cn('question', 60210),
      quote: cn('quote', 60211),
      radioTower: cn('radio-tower', 60212),
      reactions: cn('reactions', 60213),
      references: cn('references', 60214),
      refresh: cn('refresh', 60215),
      regex: cn('regex', 60216),
      remoteExplorer: cn('remote-explorer', 60217),
      remote: cn('remote', 60218),
      remove: cn('remove', 60219),
      replaceAll: cn('replace-all', 60220),
      replace: cn('replace', 60221),
      repoClone: cn('repo-clone', 60222),
      repoForcePush: cn('repo-force-push', 60223),
      repoPull: cn('repo-pull', 60224),
      repoPush: cn('repo-push', 60225),
      report: cn('report', 60226),
      requestChanges: cn('request-changes', 60227),
      rocket: cn('rocket', 60228),
      rootFolderOpened: cn('root-folder-opened', 60229),
      rootFolder: cn('root-folder', 60230),
      rss: cn('rss', 60231),
      ruby: cn('ruby', 60232),
      saveAll: cn('save-all', 60233),
      saveAs: cn('save-as', 60234),
      save: cn('save', 60235),
      screenFull: cn('screen-full', 60236),
      screenNormal: cn('screen-normal', 60237),
      searchStop: cn('search-stop', 60238),
      server: cn('server', 60240),
      settingsGear: cn('settings-gear', 60241),
      settings: cn('settings', 60242),
      shield: cn('shield', 60243),
      smiley: cn('smiley', 60244),
      sortPrecedence: cn('sort-precedence', 60245),
      splitHorizontal: cn('split-horizontal', 60246),
      splitVertical: cn('split-vertical', 60247),
      squirrel: cn('squirrel', 60248),
      starFull: cn('star-full', 60249),
      starHalf: cn('star-half', 60250),
      symbolClass: cn('symbol-class', 60251),
      symbolColor: cn('symbol-color', 60252),
      symbolConstant: cn('symbol-constant', 60253),
      symbolEnumMember: cn('symbol-enum-member', 60254),
      symbolField: cn('symbol-field', 60255),
      symbolFile: cn('symbol-file', 60256),
      symbolInterface: cn('symbol-interface', 60257),
      symbolKeyword: cn('symbol-keyword', 60258),
      symbolMisc: cn('symbol-misc', 60259),
      symbolOperator: cn('symbol-operator', 60260),
      symbolProperty: cn('symbol-property', 60261),
      wrench: cn('wrench', 60261),
      wrenchSubaction: cn('wrench-subaction', 60261),
      symbolSnippet: cn('symbol-snippet', 60262),
      tasklist: cn('tasklist', 60263),
      telescope: cn('telescope', 60264),
      textSize: cn('text-size', 60265),
      threeBars: cn('three-bars', 60266),
      thumbsdown: cn('thumbsdown', 60267),
      thumbsup: cn('thumbsup', 60268),
      tools: cn('tools', 60269),
      triangleDown: cn('triangle-down', 60270),
      triangleLeft: cn('triangle-left', 60271),
      triangleRight: cn('triangle-right', 60272),
      triangleUp: cn('triangle-up', 60273),
      twitter: cn('twitter', 60274),
      unfold: cn('unfold', 60275),
      unlock: cn('unlock', 60276),
      unmute: cn('unmute', 60277),
      unverified: cn('unverified', 60278),
      verified: cn('verified', 60279),
      versions: cn('versions', 60280),
      vmActive: cn('vm-active', 60281),
      vmOutline: cn('vm-outline', 60282),
      vmRunning: cn('vm-running', 60283),
      watch: cn('watch', 60284),
      whitespace: cn('whitespace', 60285),
      wholeWord: cn('whole-word', 60286),
      window: cn('window', 60287),
      wordWrap: cn('word-wrap', 60288),
      zoomIn: cn('zoom-in', 60289),
      zoomOut: cn('zoom-out', 60290),
      listFilter: cn('list-filter', 60291),
      listFlat: cn('list-flat', 60292),
      listSelection: cn('list-selection', 60293),
      selection: cn('selection', 60293),
      listTree: cn('list-tree', 60294),
      debugBreakpointFunctionUnverified: cn(
        'debug-breakpoint-function-unverified',
        60295
      ),
      debugBreakpointFunction: cn('debug-breakpoint-function', 60296),
      debugBreakpointFunctionDisabled: cn(
        'debug-breakpoint-function-disabled',
        60296
      ),
      debugStackframeActive: cn('debug-stackframe-active', 60297),
      circleSmallFilled: cn('circle-small-filled', 60298),
      debugStackframeDot: cn('debug-stackframe-dot', 60298),
      terminalDecorationMark: cn('terminal-decoration-mark', 60298),
      debugStackframe: cn('debug-stackframe', 60299),
      debugStackframeFocused: cn('debug-stackframe-focused', 60299),
      debugBreakpointUnsupported: cn('debug-breakpoint-unsupported', 60300),
      symbolString: cn('symbol-string', 60301),
      debugReverseContinue: cn('debug-reverse-continue', 60302),
      debugStepBack: cn('debug-step-back', 60303),
      debugRestartFrame: cn('debug-restart-frame', 60304),
      debugAlt: cn('debug-alt', 60305),
      callIncoming: cn('call-incoming', 60306),
      callOutgoing: cn('call-outgoing', 60307),
      menu: cn('menu', 60308),
      expandAll: cn('expand-all', 60309),
      feedback: cn('feedback', 60310),
      gitPullRequestReviewer: cn('git-pull-request-reviewer', 60310),
      groupByRefType: cn('group-by-ref-type', 60311),
      ungroupByRefType: cn('ungroup-by-ref-type', 60312),
      account: cn('account', 60313),
      gitPullRequestAssignee: cn('git-pull-request-assignee', 60313),
      bellDot: cn('bell-dot', 60314),
      debugConsole: cn('debug-console', 60315),
      library: cn('library', 60316),
      output: cn('output', 60317),
      runAll: cn('run-all', 60318),
      syncIgnored: cn('sync-ignored', 60319),
      pinned: cn('pinned', 60320),
      githubInverted: cn('github-inverted', 60321),
      serverProcess: cn('server-process', 60322),
      serverEnvironment: cn('server-environment', 60323),
      pass: cn('pass', 60324),
      issueClosed: cn('issue-closed', 60324),
      stopCircle: cn('stop-circle', 60325),
      playCircle: cn('play-circle', 60326),
      record: cn('record', 60327),
      debugAltSmall: cn('debug-alt-small', 60328),
      vmConnect: cn('vm-connect', 60329),
      cloud: cn('cloud', 60330),
      merge: cn('merge', 60331),
      export: cn('export', 60332),
      graphLeft: cn('graph-left', 60333),
      magnet: cn('magnet', 60334),
      notebook: cn('notebook', 60335),
      redo: cn('redo', 60336),
      checkAll: cn('check-all', 60337),
      pinnedDirty: cn('pinned-dirty', 60338),
      passFilled: cn('pass-filled', 60339),
      circleLargeFilled: cn('circle-large-filled', 60340),
      circleLarge: cn('circle-large', 60341),
      circleLargeOutline: cn('circle-large-outline', 60341),
      combine: cn('combine', 60342),
      gather: cn('gather', 60342),
      table: cn('table', 60343),
      variableGroup: cn('variable-group', 60344),
      typeHierarchy: cn('type-hierarchy', 60345),
      typeHierarchySub: cn('type-hierarchy-sub', 60346),
      typeHierarchySuper: cn('type-hierarchy-super', 60347),
      gitPullRequestCreate: cn('git-pull-request-create', 60348),
      runAbove: cn('run-above', 60349),
      runBelow: cn('run-below', 60350),
      notebookTemplate: cn('notebook-template', 60351),
      debugRerun: cn('debug-rerun', 60352),
      workspaceTrusted: cn('workspace-trusted', 60353),
      workspaceUntrusted: cn('workspace-untrusted', 60354),
      workspaceUnknown: cn('workspace-unknown', 60355),
      terminalCmd: cn('terminal-cmd', 60356),
      terminalDebian: cn('terminal-debian', 60357),
      terminalLinux: cn('terminal-linux', 60358),
      terminalPowershell: cn('terminal-powershell', 60359),
      terminalTmux: cn('terminal-tmux', 60360),
      terminalUbuntu: cn('terminal-ubuntu', 60361),
      terminalBash: cn('terminal-bash', 60362),
      arrowSwap: cn('arrow-swap', 60363),
      copy: cn('copy', 60364),
      personAdd: cn('person-add', 60365),
      filterFilled: cn('filter-filled', 60366),
      wand: cn('wand', 60367),
      debugLineByLine: cn('debug-line-by-line', 60368),
      inspect: cn('inspect', 60369),
      layers: cn('layers', 60370),
      layersDot: cn('layers-dot', 60371),
      layersActive: cn('layers-active', 60372),
      compass: cn('compass', 60373),
      compassDot: cn('compass-dot', 60374),
      compassActive: cn('compass-active', 60375),
      azure: cn('azure', 60376),
      issueDraft: cn('issue-draft', 60377),
      gitPullRequestClosed: cn('git-pull-request-closed', 60378),
      gitPullRequestDraft: cn('git-pull-request-draft', 60379),
      debugAll: cn('debug-all', 60380),
      debugCoverage: cn('debug-coverage', 60381),
      runErrors: cn('run-errors', 60382),
      folderLibrary: cn('folder-library', 60383),
      debugContinueSmall: cn('debug-continue-small', 60384),
      beakerStop: cn('beaker-stop', 60385),
      graphLine: cn('graph-line', 60386),
      graphScatter: cn('graph-scatter', 60387),
      pieChart: cn('pie-chart', 60388),
      bracket: cn('bracket', 60175),
      bracketDot: cn('bracket-dot', 60389),
      bracketError: cn('bracket-error', 60390),
      lockSmall: cn('lock-small', 60391),
      azureDevops: cn('azure-devops', 60392),
      verifiedFilled: cn('verified-filled', 60393),
      newline: cn('newline', 60394),
      layout: cn('layout', 60395),
      layoutActivitybarLeft: cn('layout-activitybar-left', 60396),
      layoutActivitybarRight: cn('layout-activitybar-right', 60397),
      layoutPanelLeft: cn('layout-panel-left', 60398),
      layoutPanelCenter: cn('layout-panel-center', 60399),
      layoutPanelJustify: cn('layout-panel-justify', 60400),
      layoutPanelRight: cn('layout-panel-right', 60401),
      layoutPanel: cn('layout-panel', 60402),
      layoutSidebarLeft: cn('layout-sidebar-left', 60403),
      layoutSidebarRight: cn('layout-sidebar-right', 60404),
      layoutStatusbar: cn('layout-statusbar', 60405),
      layoutMenubar: cn('layout-menubar', 60406),
      layoutCentered: cn('layout-centered', 60407),
      target: cn('target', 60408),
      indent: cn('indent', 60409),
      recordSmall: cn('record-small', 60410),
      errorSmall: cn('error-small', 60411),
      terminalDecorationError: cn('terminal-decoration-error', 60411),
      arrowCircleDown: cn('arrow-circle-down', 60412),
      arrowCircleLeft: cn('arrow-circle-left', 60413),
      arrowCircleRight: cn('arrow-circle-right', 60414),
      arrowCircleUp: cn('arrow-circle-up', 60415),
      layoutSidebarRightOff: cn('layout-sidebar-right-off', 60416),
      layoutPanelOff: cn('layout-panel-off', 60417),
      layoutSidebarLeftOff: cn('layout-sidebar-left-off', 60418),
      blank: cn('blank', 60419),
      heartFilled: cn('heart-filled', 60420),
      map: cn('map', 60421),
      mapHorizontal: cn('map-horizontal', 60421),
      foldHorizontal: cn('fold-horizontal', 60421),
      mapFilled: cn('map-filled', 60422),
      mapHorizontalFilled: cn('map-horizontal-filled', 60422),
      foldHorizontalFilled: cn('fold-horizontal-filled', 60422),
      circleSmall: cn('circle-small', 60423),
      bellSlash: cn('bell-slash', 60424),
      bellSlashDot: cn('bell-slash-dot', 60425),
      commentUnresolved: cn('comment-unresolved', 60426),
      gitPullRequestGoToChanges: cn('git-pull-request-go-to-changes', 60427),
      gitPullRequestNewChanges: cn('git-pull-request-new-changes', 60428),
      searchFuzzy: cn('search-fuzzy', 60429),
      commentDraft: cn('comment-draft', 60430),
      send: cn('send', 60431),
      sparkle: cn('sparkle', 60432),
      insert: cn('insert', 60433),
      mic: cn('mic', 60434),
      thumbsdownFilled: cn('thumbsdown-filled', 60435),
      thumbsupFilled: cn('thumbsup-filled', 60436),
      coffee: cn('coffee', 60437),
      snake: cn('snake', 60438),
      game: cn('game', 60439),
      vr: cn('vr', 60440),
      chip: cn('chip', 60441),
      piano: cn('piano', 60442),
      music: cn('music', 60443),
      micFilled: cn('mic-filled', 60444),
      repoFetch: cn('repo-fetch', 60445),
      copilot: cn('copilot', 60446),
      lightbulbSparkle: cn('lightbulb-sparkle', 60447),
      robot: cn('robot', 60448),
      sparkleFilled: cn('sparkle-filled', 60449),
      diffSingle: cn('diff-single', 60450),
      diffMultiple: cn('diff-multiple', 60451),
      surroundWith: cn('surround-with', 60452),
      share: cn('share', 60453),
      gitStash: cn('git-stash', 60454),
      gitStashApply: cn('git-stash-apply', 60455),
      gitStashPop: cn('git-stash-pop', 60456),
      vscode: cn('vscode', 60457),
      vscodeInsiders: cn('vscode-insiders', 60458),
      codeOss: cn('code-oss', 60459),
      runCoverage: cn('run-coverage', 60460),
      runAllCoverage: cn('run-all-coverage', 60461),
      coverage: cn('coverage', 60462),
      githubProject: cn('github-project', 60463),
      mapVertical: cn('map-vertical', 60464),
      foldVertical: cn('fold-vertical', 60464),
      mapVerticalFilled: cn('map-vertical-filled', 60465),
      foldVerticalFilled: cn('fold-vertical-filled', 60465),
      dialogError: cn('dialog-error', 'error'),
      dialogWarning: cn('dialog-warning', 'warning'),
      dialogInfo: cn('dialog-info', 'info'),
      dialogClose: cn('dialog-close', 'close'),
      treeItemExpanded: cn('tree-item-expanded', 'chevron-down'),
      treeFilterOnTypeOn: cn('tree-filter-on-type-on', 'list-filter'),
      treeFilterOnTypeOff: cn('tree-filter-on-type-off', 'list-selection'),
      treeFilterClear: cn('tree-filter-clear', 'close'),
      treeItemLoading: cn('tree-item-loading', 'loading'),
      menuSelection: cn('menu-selection', 'check'),
      menuSubmenu: cn('menu-submenu', 'chevron-right'),
      menuBarMore: cn('menubar-more', 'more'),
      scrollbarButtonLeft: cn('scrollbar-button-left', 'triangle-left'),
      scrollbarButtonRight: cn('scrollbar-button-right', 'triangle-right'),
      scrollbarButtonUp: cn('scrollbar-button-up', 'triangle-up'),
      scrollbarButtonDown: cn('scrollbar-button-down', 'triangle-down'),
      toolBarMore: cn('toolbar-more', 'more'),
      quickInputBack: cn('quick-input-back', 'arrow-left'),
      dropDownButton: cn('drop-down-button', 60084),
      symbolCustomColor: cn('symbol-customcolor', 60252),
      exportIcon: cn('export', 60332),
      workspaceUnspecified: cn('workspace-unspecified', 60355),
      newLine: cn('newline', 60394),
      thumbsDownFilled: cn('thumbsdown-filled', 60435),
      thumbsUpFilled: cn('thumbsup-filled', 60436),
      gitFetch: cn('git-fetch', 60445),
      lightbulbSparkleAutofix: cn('lightbulb-sparkle-autofix', 60447),
      debugBreakpointPending: cn('debug-breakpoint-pending', 60377),
    };
    class mn extends b {
      get isResolved() {
    ...
    !(function (e) {
      const t = new Map();
      t.set(0, dn.symbolMethod),
        t.set(1, dn.symbolFunction),
        t.set(2, dn.symbolConstructor),
        t.set(3, dn.symbolField),
        t.set(4, dn.symbolVariable),
        t.set(5, dn.symbolClass),
        t.set(6, dn.symbolStruct),
        t.set(7, dn.symbolInterface),
        t.set(8, dn.symbolModule),
        t.set(9, dn.symbolProperty),
        t.set(10, dn.symbolEvent),
        t.set(11, dn.symbolOperator),
        t.set(12, dn.symbolUnit),
        t.set(13, dn.symbolValue),
        t.set(15, dn.symbolEnum),
        t.set(14, dn.symbolConstant),
        t.set(15, dn.symbolEnum),
        t.set(16, dn.symbolEnumMember),
        t.set(17, dn.symbolKeyword),
        t.set(27, dn.symbolSnippet),
        t.set(18, dn.symbolText),
        t.set(19, dn.symbolColor),
        t.set(20, dn.symbolFile),
        t.set(21, dn.symbolReference),
        t.set(22, dn.symbolCustomColor),
        t.set(23, dn.symbolFolder),
        t.set(24, dn.symbolTypeParameter),
        t.set(25, dn.account),
        t.set(26, dn.issues),
        (e.toIcon = function (e) {
          let n = t.get(e);
      ...
      (function (e) {
        const t = new Map();
        t.set(0, dn.symbolFile),
          t.set(1, dn.symbolModule),
          t.set(2, dn.symbolNamespace),
          t.set(3, dn.symbolPackage),
          t.set(4, dn.symbolClass),
          t.set(5, dn.symbolMethod),
          t.set(6, dn.symbolProperty),
          t.set(7, dn.symbolField),
          t.set(8, dn.symbolConstructor),
          t.set(9, dn.symbolEnum),
          t.set(10, dn.symbolInterface),
          t.set(11, dn.symbolFunction),
          t.set(12, dn.symbolVariable),
          t.set(13, dn.symbolConstant),
          t.set(14, dn.symbolString),
          t.set(15, dn.symbolNumber),
          t.set(16, dn.symbolBoolean),
          t.set(17, dn.symbolArray),
          t.set(18, dn.symbolObject),
          t.set(19, dn.symbolKey),
          t.set(20, dn.symbolNull),
          t.set(21, dn.symbolEnumMember),
          t.set(22, dn.symbolStruct),
          t.set(23, dn.symbolEvent),
          t.set(24, dn.symbolOperator),
          t.set(25, dn.symbolTypeParameter),
          (e.toIcon = function (e) {
            let n = t.get(e);
            return (
              n ||
    ...
    (vi.Comment = new vi('comment')),
      (vi.Imports = new vi('imports')),
      (vi.Region = new vi('region')),
      (function (e) {
      ...
      new (class {
        ...
        registerFactory(e, t) {
          ...
          const i = new mn(this, e, t);
          return (
            this._factories.set(e, i),
            f(() => {
              const t = this._factories.get(e);
              t && t === i && (this._factories.delete(e), t.dispose());
            })
          );
        }
        async getOrCreate(e) {
    ...
    (yi.CtrlCmd = 2048), (yi.Shift = 1024), (yi.Alt = 512), (yi.WinCtrl = 256);
    class Ci {
      constructor(e, t) {
    ...
    class Li {
      constructor(e, t) {
        if (((this[gi] = 'ResourceMap'), e instanceof Li))
          (this.map = new Map(e.map)),
            (this.toKey = null != t ? t : Li.defaultToKey);
        else if (
          (function (e) {
          ...
          (this.map = new Map()),
            (this.toKey = null != e ? e : Li.defaultToKey);
      }
      set(e, t) {
        return this.map.set(this.toKey(e), new Ci(e, t)), this;
      }
      get(e) {
        var t;
    ...
    class wi {
      ...
      [((fi = Symbol.toStringTag), Symbol.iterator)]() {
        return this.entries();
      }
      trimOld(e) {
      ...
      next(e) {
        ...
        do {
          ...
          if (i === this._prevMatchStartIndex && r === this._prevMatchLength) {
            if (0 === r) {
              me(e, t, this._searchRegex.lastIndex) > 65535
          ...
          if (
            ...
            !this._wordSeparators || Ei(this._wordSeparators, e, t, i, r))
          )
            return n;
        } while (n);
        return null;
    ...
    class Mi {
      static computeUnicodeHighlights(e, t, n) {
        const i = n ? n.startLineNumber : 1,
          r = n ? n.endLineNumber : e.getLineCount(),
          s = new ki(t),
        ...
        e: for (let t = i, n = r; t <= n; t++) {
          ...
          do {
            if (((c = u.next(n)), c)) {
              ...
              e > 0 && he(n.charCodeAt(e - 1)) && e--,
                r + 1 < i && he(n.charCodeAt(r - 1)) && r++;
              const o = n.substring(e, r);
              let a = Kt(e + 1, Pt, n, 0);
              a && a.endColumn <= e + 1 && (a = null);
              const l = s.shouldHighlightNonBasicASCII(o, a ? a.word : null);
              if (0 !== l) {
                3 === l ? m++ : 2 === l ? g++ : 1 === l ? f++ : Ri();
                const n = 1e3;
                if (h.length >= n) {
                  d = !0;
                  break e;
                }
                h.push(new Et(t, e + 1, t, r + 1));
              }
            }
          } while (c);
        }
        ...
        switch (n.shouldHighlightNonBasicASCII(e, null)) {
          ...
          case 3: {
            const i = e.codePointAt(0),
              r = n.ambiguousCharacters.getPrimaryConfusable(i),
              s = pe
                .getLocales()
                .filter(
                  (e) =>
    ...
    class ki {
      constructor(e) {
        (this.options = e),
          ...
          (this.ambiguousCharacters = pe.getInstance(
      ...
      getCandidateCodePoints() {
        ...
        if (this.options.invisibleCharacters)
          for (const t of be.codePoints)
            Ti(String.fromCodePoint(t)) || e.add(t);
    ...
    class Pi {
      static addRange(e, t) {
        ...
        if (n === i) t.splice(n, 0, e);
        else {
          const r = Math.min(e.start, t[n].start),
            s = Math.max(e.endExclusive, t[i - 1].endExclusive);
          t.splice(n, i - n, new Pi(r, s));
        }
      }
      static tryCreate(e, t) {
        if (!(e > t)) return new Pi(e, t);
      }
      static ofLength(e) {
        return new Pi(0, e);
      }
      ...
      constructor(e, t) {
        if (((this.start = e), (this.endExclusive = t), e > t))
          throw new a(`Invalid range: ${this.toString()}`);
      }
      get isEmpty() {
        return this.start === this.endExclusive;
      }
      delta(e) {
        return new Pi(this.start + e, this.endExclusive + e);
      }
      deltaStart(e) {
        return new Pi(this.start + e, this.endExclusive);
      }
      deltaEnd(e) {
        return new Pi(this.start, this.endExclusive + e);
      }
      get length() {
      ...
      clip(e) {
        if (this.isEmpty)
          throw new a(`Invalid clipping range: ${this.toString()}`);
    ...
    function Fi(e, t, n = 0, i = e.length) {
      let r = n,
        s = i;
      for (; r < s; ) {
    ...
    class qi {
      ...
      findLastMonotonous(e) {
        ...
        const t = Fi(this._array, e, this._findLastMonotonousLastIdx);
        return (
    ...
    qi.assertInvariants = !1;
    class Vi {
      static fromRangeInclusive(e) {
        return new Vi(e.startLineNumber, e.endLineNumber + 1);
      }
      static joinMany(e) {
        if (0 === e.length) return [];
        let t = new Bi(e[0].slice());
        for (let n = 1; n < e.length; n++) t = t.getUnion(new Bi(e[n].slice()));
        return t.ranges;
      }
      static join(e) {
        ...
        for (let i = 1; i < e.length; i++)
          (t = Math.min(t, e[i].startLineNumber)),
            (n = Math.max(n, e[i].endLineNumberExclusive));
        return new Vi(t, n);
      }
      static ofLength(e, t) {
        return new Vi(e, e + t);
      ...
      deltaLength(e) {
        return new Vi(this.startLineNumber, this.endLineNumberExclusive + e);
      }
      get length() {
      ...
      toExclusiveRange() {
        return new Et(this.startLineNumber, 1, this.endLineNumberExclusive, 1);
      }
      mapToLineArray(e) {
        const t = [];
    ...
    class Bi {
      ...
      addRange(e) {
        ...
        if (t === n) this._normalizedRanges.splice(t, 0, e);
          ...
          const i = this._normalizedRanges[t]
      ...
      contains(e) {
        const t = Di(this._normalizedRanges, (t) => t.startLineNumber <= e);
      ...
      getUnion(e) {
        ...
        for (
          ;
          n < this._normalizedRanges.length || i < e._normalizedRanges.length;
        ...
        return null !== r && t.push(r), new Bi(t);
      }
      subtractFrom(e) {
        const t = Ki(
            this._normalizedRanges,
        ...
        if (t === n) return new Bi([e]);
        const i = [];
        let r = e.startLineNumber;
        for (let e = t; e < n; e++) {
          const t = this._normalizedRanges[e];
          t.startLineNumber > r && i.push(new Vi(r, t.startLineNumber)),
            (r = t.endLineNumberExclusive);
        }
        return (
          r < e.endLineNumberExclusive &&
            i.push(new Vi(r, e.endLineNumberExclusive)),
          new Bi(i)
        );
      }
      toString() {
      ...
      getIntersection(e) {
        ...
        for (
          ...
          o && !o.isEmpty && t.push(o),
            r.endLineNumberExclusive < s.endLineNumberExclusive ? n++ : i++;
        }
        return new Bi(t);
      }
      getWithDelta(e) {
        return new Bi(this._normalizedRanges.map((t) => t.delta(e)));
      }
    }
    class Ui {
      static inverse(e, t, n) {
        ...
        for (const t of e) {
          const e = new Ui(
            new Vi(r, t.original.startLineNumber),
            new Vi(s, t.modified.startLineNumber)
          );
          e.modified.isEmpty || i.push(e),
            (r = t.original.endLineNumberExclusive),
            (s = t.modified.endLineNumberExclusive);
        }
        const o = new Ui(new Vi(r, t + 1), new Vi(s, n + 1));
      ...
      static clip(e, t, n) {
        ...
        for (const r of e) {
          ...
          e && !e.isEmpty && s && !s.isEmpty && i.push(new Ui(e, s));
        }
        return i;
      }
      constructor(e, t) {
      ...
      flip() {
        return new Ui(this.modified, this.original);
      }
      join(e) {
        return new Ui(
    ...
    class Hi extends Ui {
      static fromRangeMappings(e) {
        const t = Vi.join(e.map((e) => Vi.fromRangeInclusive(e.originalRange))),
          n = Vi.join(e.map((e) => Vi.fromRangeInclusive(e.modifiedRange)));
        return new Hi(t, n, e);
      }
      constructor(e, t, n) {
      ...
      withInnerChangesFromLineRanges() {
        return new Hi(this.original, this.modified, [
          new Wi(
            this.original.toExclusiveRange(),
            this.modified.toExclusiveRange()
          ),
        ]);
      }
    }
        ...
        for (const e of r.changes) {
          ...
          (t =
            0 === e.originalEndLineNumber
              ...
              : new Vi(e.originalStartLineNumber, e.originalEndLineNumber + 1)),
            (n =
          ...
          o &&
            ((o.modified.endLineNumberExclusive !==
              ...
              ((r = new Hi(
                o.original.join(r.original),
                o.modified.join(r.modified),
                o.innerChanges && r.innerChanges
                  ? o.innerChanges.concat(r.innerChanges)
                  : void 0
              )),
              s.pop())),
            s.push(r),
    ...
    class ji {
      ...
      createCharSequence(e, t, n) {
        ...
        for (let a = t; a <= n; a++) {
          ...
          !e &&
            a < n &&
            ((i[o] = 10), (r[o] = a + 1), (s[o] = t.length + 1), o++);
        }
        return new Gi(i, r, s);
      }
    }
        ...
        if (
          ...
          if (s.getElements().length > 0 && a.getElements().length > 0) {
            ...
            o &&
              ...
              (c = []);
            for (let t = 0, n = e.length; t < n; t++)
              c.push(Qi.createFromDiffChange(e[t], s, a));
          }
        }
        return new Ji(a, l, u, h, c);
      }
    }
    class Yi {
      constructor(e, t, n) {
        (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
          ...
          (this.original = new ji(e)),
          (this.modified = new ji(t)),
          (this.continueLineDiff = er(n.maxComputationTime)),
            ...
            if (e !== t) {
              {
                ...
                for (
                  ;
                  n > 1 && o > 1 && e.charCodeAt(n - 2) === t.charCodeAt(o - 2);
              ...
              }
              {
                ...
                for (
                  ;
                  n < a && o < l && e.charCodeAt(n - 1) === e.charCodeAt(o - 1);
      ...
      _pushTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
        ...
        let a;
        this.shouldComputeCharChanges && (a = [new Qi(t, n, t, i, r, s, r, o)]),
          e.push(new Ji(t, t, r, r, a));
      }
      _mergeTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
        ...
        return (
          ...
          (l.originalEndLineNumber === t && l.modifiedEndLineNumber === r
            ? (this.shouldComputeCharChanges &&
                l.charChanges &&
                l.charChanges.push(new Qi(t, n, t, i, r, s, r, o)),
              !0)
    ...
    class tr {
      static trivial(e, t) {
        return new tr(
          [new nr(Pi.ofLength(e.length), Pi.ofLength(t.length))],
          !1
        );
      }
    ...
    class nr {
      static invert(e, t) {
        ...
        return (
          (function (e, i) {
            for (let i = 0; i <= e.length; i++)
              (r = 0 === i ? void 0 : e[i - 1]),
                (s = i === e.length ? void 0 : e[i]),
                n.push(
                  nr.fromOffsetPairs(
                    r ? r.getEndExclusives() : ir.zero,
                    s
                      ? s.getStarts()
                      : new ir(
                          t,
      ...
      static fromOffsetPairs(e, t) {
        return new nr(
          new Pi(e.offset1, t.offset1),
          new Pi(e.offset2, t.offset2)
        );
      }
      constructor(e, t) {
      ...
      swap() {
        return new nr(this.seq2Range, this.seq1Range);
      }
      toString() {
      ...
      delta(e) {
        return 0 === e
          ? this
          : new nr(this.seq1Range.delta(e), this.seq2Range.delta(e));
      }
      deltaStart(e) {
        return 0 === e
          ? this
          : new nr(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e));
      }
      deltaEnd(e) {
        return 0 === e
          ? this
          : new nr(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e));
      }
      intersect(e) {
      ...
      getStarts() {
        return new ir(this.seq1Range.start, this.seq2Range.start);
      }
      getEndExclusives() {
        return new ir(this.seq1Range.endExclusive, this.seq2Range.endExclusive);
      }
    }
    class ir {
      constructor(e, t) {
      ...
      delta(e) {
        return 0 === e ? this : new ir(this.offset1 + e, this.offset2 + e);
      }
      equals(e) {
    ...
    (ir.zero = new ir(0, 0)),
      (ir.max = new ir(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER));
    class rr {
      isValid() {
        return !0;
      }
    ...
    class sr {
      constructor(e) {
        if (
          ...
          throw new a('timeout must be positive');
      }
      isValid() {
        return (
    ...
    class lr {
      ...
      computeSimilarity(e) {
        ...
        for (let s = 0; s < r; s++)
          i += Math.abs(
            (null !== (t = this.histogram[s]) && void 0 !== t ? t : 0) -
              (null !== (n = e.histogram[s]) && void 0 !== n ? n : 0)
          );
        return 1 - i / (this.totalCount + e.totalCount);
      }
    }
    lr.chrKeys = new Map();
    class ur {
      compute(e, t, n = rr.instance, i) {
        if (0 === e.length || 0 === t.length) return tr.trivial(e, t);
        const r = new or(e.length, t.length),
          s = new or(e.length, t.length),
          o = new or(e.length, t.length);
        for (let a = 0; a < e.length; a++)
          for (let l = 0; l < t.length; l++) {
            if (!n.isValid()) return tr.trivialTimedOut(e, t);
            const u = 0 === a ? 0 : r.get(a - 1, l),
              h = 0 === l ? 0 : r.get(a, l - 1);
            let c;
            e.getElement(a) === t.getElement(l)
              ? ((c = 0 === a || 0 === l ? 0 : r.get(a - 1, l - 1)),
                a > 0 &&
                  l > 0 &&
                  3 === s.get(a - 1, l - 1) &&
                  (c += o.get(a - 1, l - 1)),
                (c += i ? i(a, l) : 1))
              : (c = -1);
            const d = Math.max(u, h, c);
            if (d === c) {
              const e = a > 0 && l > 0 ? o.get(a - 1, l - 1) : 0;
              o.set(a, l, e + 1), s.set(a, l, 3);
            } else
              d === u
                ? (o.set(a, l, 0), s.set(a, l, 1))
                : d === h && (o.set(a, l, 0), s.set(a, l, 2));
            r.set(a, l, d);
          }
        const a = [];
        let l = e.length,
        ...
        function h(e, t) {
          (e + 1 === l && t + 1 === u) ||
            a.push(new nr(new Pi(e + 1, l), new Pi(t + 1, u))),
            (l = e),
            (u = t);
        }
        let c = e.length - 1,
        ...
        for (; c >= 0 && d >= 0; )
          3 === s.get(c, d)
            ...
            : 1 === s.get(c, d)
              ? c--
              : d--;
        return h(-1, -1), a.reverse(), new tr(a, !1);
      }
    }
    class hr {
      compute(e, t, n = rr.instance) {
        ...
        function s(e, t) {
          for (
            ;
            e < i.length && t < r.length && i.getElement(e) === r.getElement(t);
        ...
        a.set(0, s(0, 0));
        const l = new mr();
        l.set(0, 0 === a.get(0) ? null : new cr(null, 0, 0, a.get(0)));
        let u = 0;
        e: for (;;) {
          if ((o++, !n.isValid())) return tr.trivialTimedOut(i, r);
          const e = -Math.min(o, r.length + (o % 2)),
            t = Math.min(o, i.length + (o % 2));
          for (u = e; u <= t; u += 2) {
            let n = 0;
            const o = u === t ? -1 : a.get(u + 1),
              h = u === e ? -1 : a.get(u - 1) + 1;
            n++;
            const c = Math.min(Math.max(o, h), i.length),
              d = c - u;
            if ((n++, c > i.length || d > r.length)) continue;
            const m = s(c, d);
            a.set(u, m);
            const g = c === o ? l.get(u + 1) : l.get(u - 1);
            if (
              (l.set(u, m !== c ? new cr(g, c, d, m - c) : g),
              a.get(u) === i.length && a.get(u) - u === r.length)
            )
              break e;
          }
        }
        ...
        for (;;) {
          const e = h ? h.x + h.length : 0,
            t = h ? h.y + h.length : 0;
          if (
            ((e === d && t === m) || c.push(new nr(new Pi(e, d), new Pi(t, m))),
            !h)
          )
            break;
          (d = h.x), (m = h.y), (h = h.prev);
        }
        return c.reverse(), new tr(c, !1);
      }
    }
    class cr {
      constructor(e, t, n, i) {
    ...
    class gr {
      constructor(e, t, n) {
        ...
        t.start > 0 &&
          ...
          ((t = new Pi(t.start - 1, t.endExclusive)), (i = !0)),
          (this.lineRange = t),
        ...
        for (
          ...
          for (let e = 0; e < r.length; e++)
            this.elements.push(r.charCodeAt(e));
          t < e.length - 1 &&
            (this.elements.push('\n'.charCodeAt(0)),
      ...
      get text() {
        return this.getText(new Pi(0, this.length));
      }
      getText(e) {
      ...
      getBoundaryScore(e) {
        const t = _r(e > 0 ? this.elements[e - 1] : -1),
          n = _r(e < this.elements.length ? this.elements[e] : -1);
        if (7 === t && 8 === n) return 0;
        if (8 === t) return 150;
        let i = 0;
        return (
          t !== n && ((i += 10), 0 === t && 1 === n && (i += 1)),
          (i += br(t)),
          (i += br(n)),
          i
        );
      ...
      translateOffset(e) {
        if (this.lineRange.isEmpty) return new Nt(this.lineRange.start + 1, 1);
        const t = Fi(this.firstCharOffsetByLine, (t) => t <= e);
        return new Nt(
          this.lineRange.start + t + 1,
          e - this.firstCharOffsetByLine[t] + this.additionalOffsetByLine[t] + 1
        );
      }
      translateRange(e) {
        return Et.fromPositions(
      ...
      findWordContaining(e) {
        ...
        if (!fr(this.elements[e])) return;
        let t = e;
        for (; t > 0 && fr(this.elements[t - 1]); ) t--;
        let n = e;
        for (; n < this.elements.length && fr(this.elements[n]); ) n++;
        return new Pi(t, n);
      }
      countLinesIn(e) {
        return (
      ...
      extendToFullLines(e) {
        ...
        const i =
            null !==
              (t = Di(this.firstCharOffsetByLine, (t) => t <= e.start)) &&
            void 0 !== t
              ? t
              : 0,
          r =
            null !==
              (n = (function (t, n) {
                const i = Ki(t, (t) => e.endExclusive <= t);
                return i === t.length ? void 0 : t[i];
              })(this.firstCharOffsetByLine)) && void 0 !== n
              ? n
              : this.elements.length;
        return new Pi(i, r);
      }
    ...
    const pr = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 };
    function br(e) {
      return pr[e];
    }
    function _r(e) {
    ...
    function vr(e, t, n) {
      ...
      const i = new hr().compute(
        new gr([e], new Pi(0, 1), !1),
        new gr([t], new Pi(0, 1), !1),
        n
      );
      let r = 0;
      const s = nr.invert(i.diffs, e.length);
      for (const t of s)
      ...
      return (
        ...
        (i = (function (e, t, n) {
          ...
          for (let i = 0; i < n.length; i++) {
            ...
            s.seq1Range.isEmpty
              ? (n[i] = Lr(s, e, t, a, l))
              : s.seq2Range.isEmpty && (n[i] = Lr(s.swap(), t, e, l, a).swap());
          }
          return n;
        })(e, t, i)),
        i
    ...
    function Cr(e, t, n) {
      ...
      for (let r = 1; r < n.length; r++) {
        ...
        if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
          const n = o.seq1Range.start - s.seq1Range.endExclusive;
          let r;
          for (
            r = 1;
            r <= n &&
            e.getElement(o.seq1Range.start - r) ===
              e.getElement(o.seq1Range.endExclusive - r) &&
            t.getElement(o.seq2Range.start - r) ===
              t.getElement(o.seq2Range.endExclusive - r);
            r++
          );
          if ((r--, r === n)) {
            i[i.length - 1] = new nr(
              new Pi(s.seq1Range.start, o.seq1Range.endExclusive - n),
              new Pi(s.seq2Range.start, o.seq2Range.endExclusive - n)
            );
            continue;
          }
          o = o.delta(-r);
      ...
      for (let n = 0; n < i.length - 1; n++) {
        ...
        let o = i[n];
        if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
          const r = s.seq1Range.start - o.seq1Range.endExclusive;
          let a;
          for (
            a = 0;
            a < r &&
          ...
          if (a === r) {
            i[n + 1] = new nr(
              new Pi(o.seq1Range.start + r, s.seq1Range.endExclusive),
              new Pi(o.seq2Range.start + r, s.seq2Range.endExclusive)
            );
            continue;
          }
          a > 0 && (o = o.delta(a));
    ...
    function Lr(e, t, n, i, r) {
      ...
      for (
        ;
        e.seq1Range.start - s >= i.start &&
        e.seq2Range.start - s >= r.start &&
        n.isStronglyEqual(
          e.seq2Range.start - s,
      ...
      for (
        ;
        e.seq1Range.start + o < i.endExclusive &&
        e.seq2Range.endExclusive + o < r.endExclusive &&
        n.isStronglyEqual(
          e.seq2Range.start + o,
      ...
      for (let i = -s; i <= o; i++) {
        const r = e.seq2Range.start + i,
          ...
          u =
            t.getBoundaryScore(o) +
            n.getBoundaryScore(r) +
            n.getBoundaryScore(s);
        u > l && ((l = u), (a = i));
      }
      return e.delta(a);
    }
    class wr {
      ...
      getBoundaryScore(e) {
        return (
          1e3 -
          ((0 === e ? 0 : Nr(this.lines[e - 1])) +
            (e === this.lines.length ? 0 : Nr(this.lines[e])))
        );
      }
      getText(e) {
    ...
    class Er {
      constructor() {
        (this.dynamicProgrammingDiffing = new ur()),
          (this.myersDiffingAlgorithm = new hr());
      }
      computeDiff(e, t, n) {
        if (
          e.length <= 1 &&
        ...
        if (
          ...
          return new Oi(
            [
              new Hi(new Vi(1, e.length + 1), new Vi(1, t.length + 1), [
                new Wi(
                  new Et(1, 1, e.length, e[0].length + 1),
                  new Et(1, 1, t.length, t[0].length + 1)
                ),
              ]),
            ],
            [],
        ...
        const i =
            0 === n.maxComputationTimeMs
              ? rr.instance
              : new sr(n.maxComputationTimeMs),
          r = !n.ignoreTrimWhitespace,
          s = new Map();
        function o(e) {
          let t = s.get(e);
        ...
        const a = e.map((e) => o(e.trim())),
          ...
          h = new wr(l, t),
          c = (() =>
            u.length + h.length < 1700
              ? this.dynamicProgrammingDiffing.compute(u, h, i, (n, i) =>
                  e[n] === t[i]
                    ? 0 === t[i].length
                      ? 0.1
                      : 1 + Math.log(1 + t[i].length)
                    : 0.99
                )
              : this.myersDiffingAlgorithm.compute(u, h))();
        let d = c.diffs,
          m = c.hitTimeout;
        (d = yr(u, h, d)),
          (d = (function (e, t, n) {
            ...
            do {
              ...
              for (let a = 1; a < i.length; a++) {
                const l = i[a],
                  u = o[o.length - 1];
                function h(t, n) {
                  const i = new Pi(u.seq1Range.endExclusive, l.seq1Range.start);
                  return (
                    e.getText(i).replace(/\s/g, '').length <= 4 &&
                    (t.seq1Range.length + t.seq2Range.length > 5 ||
                      n.seq1Range.length + n.seq2Range.length > 5)
                  );
                }
                h(u, l)
                  ? ((r = !0), (o[o.length - 1] = o[o.length - 1].join(l)))
                  : o.push(l);
              }
              i = o;
            } while (s++ < 10 && r);
              ...
              for (let s = 0; s < n; s++) {
                ...
                if (e[n] !== t[o]) {
                  const s = this.refineDiff(
                    e,
                    t,
                    new nr(new Pi(n, n + 1), new Pi(o, o + 1)),
                    i,
                    r
                  );
        ...
        let p = 0,
          b = 0;
        for (const n of d) {
          Ai(() => n.seq1Range.start - p == n.seq2Range.start - b),
            f(n.seq1Range.start - p),
            (p = n.seq1Range.endExclusive),
            (b = n.seq2Range.endExclusive);
          const s = this.refineDiff(e, t, n, i, r);
          s.hitTimeout && (m = !0);
          for (const e of s.mappings) g.push(e);
        }
        f(e.length - p);
        ...
        let v = [];
        return (
          n.computeMoves && (v = this.computeMoves(_, e, t, a, l, i, r)),
          Ai(() => {
            function n(e, t) {
            ...
            for (const r of _) {
              ...
              for (const i of r.innerChanges)
                if (
                  !(
                    n(i.modifiedRange.getStartPosition(), t) &&
                    n(i.modifiedRange.getEndPosition(), t) &&
                    n(i.originalRange.getStartPosition(), e) &&
                    n(i.originalRange.getEndPosition(), e)
                  )
                )
                  return !1;
      ...
      computeMoves(e, t, n, i, r, s, o) {
        return (function (e, t, n, i, r, s) {
          let { moves: o, excludedChanges: a } = (function (e, t, n, i) {
            const r = [],
              s = e
                .filter((e) => e.modified.isEmpty && e.original.length >= 3)
                .map((e) => new lr(e.original, t, e)),
              o = new Set(
                e
                  .filter((e) => e.original.isEmpty && e.modified.length >= 3)
                  .map((e) => new lr(e.modified, n, e))
              ),
              a = new Set();
            for (const e of s) {
              let t,
              ...
              if (
                (n > 0.9 &&
                  t &&
                  (o.delete(t),
                  r.push(new Ui(e.range, t.range)),
                  a.add(e.source),
                  a.add(t.source)),
                !i.isValid())
              )
                return { moves: r, excludedChanges: a };
            }
            return { moves: r, excludedChanges: a };
          })(e, t, n, s);
          if (!s.isValid()) return [];
          const l = (function (e, t, n, i, r, s) {
            ...
            for (const n of e)
              for (
                ...
                a.add(n, { range: new Vi(e, e + 3) });
              }
            const l = [];
            e.sort(Rt((e) => e.modified.startLineNumber, At));
            for (const t of e) {
              let e = [];
              for (
                let i = t.modified.startLineNumber;
                i < t.modified.endLineNumberExclusive - 2;
                i++
              ) {
                ...
                a.forEach(t, ({ range: t }) => {
                  for (const n of e)
                    if (
                      ...
                      return (
                        (n.originalLineRange = new Vi(
                          n.originalLineRange.startLineNumber,
                          t.endLineNumberExclusive
                        )),
                        (n.modifiedLineRange = new Vi(
            ...
            var u;
            l.sort(
              ((u = Rt((e) => e.modifiedLineRange.length, At)),
              (e, t) => -u(e, t))
            );
            const h = new Bi(),
              c = new Bi();
            for (const e of l) {
              const t =
                ...
                n = h.subtractFrom(e.modifiedLineRange),
                i = c.subtractFrom(e.originalLineRange).getWithDelta(t),
                r = n.getIntersection(i);
              for (const e of r.ranges) {
                if (e.length < 3) continue;
                const n = e,
                  i = e.delta(-t);
                o.push(new Ui(i, n)), h.addRange(n), c.addRange(i);
              }
            }
            o.sort(Rt((e) => e.original.startLineNumber, At));
            const d = new qi(e);
            for (let t = 0; t < o.length; t++) {
              const n = o[t],
                a = d.findLastMonotonous(
                  (e) =>
                    e.original.startLineNumber <= n.original.startLineNumber
                ),
                l = Di(
                  e,
                  (e) =>
                    e.modified.startLineNumber <= n.modified.startLineNumber
                ),
                u = Math.max(
                  n.original.startLineNumber - a.original.startLineNumber,
                  n.modified.startLineNumber - l.modified.startLineNumber
                ),
                m = d.findLastMonotonous(
                  (e) =>
              ...
              for (p = 0; p < u; p++) {
                ...
                if (e > i.length || t > r.length) break;
                if (h.contains(t) || c.contains(e)) break;
                if (!vr(i[e - 1], r[t - 1], s)) break;
              }
              for (
                p > 0 &&
                  (c.addRange(
          ...
          return (
            ...
            (o = (function (e) {
              ...
              e.sort(Rt((e) => e.original.startLineNumber, At));
              const t = [e[0]];
          ...
          const i = Sr(
            this.refineDiff(
              t,
              n,
              new nr(e.original.toOffsetRange(), e.modified.toOffsetRange()),
              s,
              o
            ).mappings,
            t,
      ...
      refineDiff(e, t, n, i, r) {
        const s = new gr(e, n.seq1Range, r),
          o = new gr(t, n.seq2Range, r),
          a =
            s.length + o.length < 500
              ? this.dynamicProgrammingDiffing.compute(s, o, i)
              : this.myersDiffingAlgorithm.compute(s, o, i);
        let l = a.diffs;
        return (
          (l = yr(s, o, l)),
          (l = (function (e, t, n) {
            const i = nr.invert(n, e.length),
              r = [];
            let s = new ir(0, 0);
            function o(n, o) {
              ...
              if (!a || !l) return;
              let u = new nr(a, l);
              const h = u.intersect(o);
              let c = h.seq1Range.length,
                d = h.seq2Range.length;
              for (; i.length > 0; ) {
                const n = i[0];
                if (
                  !n.seq1Range.intersects(u.seq1Range) &&
                  !n.seq2Range.intersects(u.seq2Range)
                )
                  break;
                const r = e.findWordContaining(n.seq1Range.start),
                  s = t.findWordContaining(n.seq2Range.start),
                  o = new nr(r, s),
                  a = o.intersect(n);
                if (
                  ((c += a.seq1Range.length),
                  (d += a.seq2Range.length),
                  (u = u.join(o)),
              ...
              c + d < (2 * (u.seq1Range.length + u.seq2Range.length)) / 3 &&
                r.push(u),
                (s = u.getEndExclusives());
            }
            for (; i.length > 0; ) {
              const e = i.shift();
              e.seq1Range.isEmpty ||
                (o(e.getStarts(), e), o(e.getEndExclusives().delta(-1), e));
            }
            return (function (e, t) {
              const n = [];
            ...
            do {
              ...
              for (let l = 1; l < i.length; l++) {
                const u = i[l],
                  h = a[a.length - 1];
                function c(n, i) {
                  const r = new Pi(h.seq1Range.endExclusive, u.seq1Range.start);
                  if (e.countLinesIn(r) > 5 || r.length > 500) return !1;
                  const s = e.getText(r).trim();
                  if (s.length > 20 || s.split(/\r\n|\r|\n/).length > 1)
                    return !1;
                  const o = e.countLinesIn(n.seq1Range),
                    a = n.seq1Range.length,
                    l = t.countLinesIn(n.seq2Range),
                    c = n.seq2Range.length,
                    d = e.countLinesIn(i.seq1Range),
                    m = i.seq1Range.length,
                    g = t.countLinesIn(i.seq2Range),
                    f = i.seq2Range.length;
                  function p(e) {
                  ...
                  return (
                    Math.pow(
                      Math.pow(p(40 * o + a), 1.5) +
                        Math.pow(p(40 * l + c), 1.5),
                      1.5
                    ) +
                      Math.pow(
                        Math.pow(p(40 * d + m), 1.5) +
                          Math.pow(p(40 * g + f), 1.5),
                        1.5
                      ) >
                    74184.96480721243
                  );
                ...
                c(h, u)
                  ? ((r = !0), (a[a.length - 1] = a[a.length - 1].join(u)))
                  : a.push(u);
              }
              i = a;
            } while (s++ < 10 && r);
            ...
            return (
              (function (e, t) {
                ...
                const a = e.extendToFullLines(n.seq1Range),
                  l = e.getText(new Pi(a.start, n.seq1Range.start));
                s(l) && (r = r.deltaStart(-l.length));
                const u = e.getText(
                  new Pi(n.seq1Range.endExclusive, a.endExclusive)
                );
                s(u) && (r = r.deltaEnd(u.length));
                const h = nr.fromOffsetPairs(
                    t ? t.getEndExclusives() : ir.zero,
                    i ? i.getStarts() : ir.max
                  ),
                  c = r.intersect(h);
                o.length > 0 &&
                c.getStarts().equals(o[o.length - 1].getEndExclusives())
                  ? (o[o.length - 1] = o[o.length - 1].join(c))
                  : o.push(c);
              }),
              o
            );
          })(s, o, l)),
          {
            mappings: l.map(
              (e) =>
                new Wi(
                  s.translateRange(e.seq1Range),
                  o.translateRange(e.seq2Range)
                )
            ),
    ...
    function Sr(e, t, n, i = !1) {
      ...
      for (const i of (function* (e, t) {
        ...
        for (const t of e)
          void 0 !== i &&
          ((s = t),
          (r = i).original.overlapOrTouch(s.original) ||
            r.modified.overlapOrTouch(s.modified))
            ? n.push(t)
            : (n && (yield n), (n = [t])),
            (i = t);
        var r, s;
      ...
      return (
        Ai(() => {
          if (!i && r.length > 0) {
            if (r[0].modified.startLineNumber !== r[0].original.startLineNumber)
              return !1;
            if (
          ...
          return xi(
            r,
            (e, t) =>
              t.original.startLineNumber - e.original.endLineNumberExclusive ==
                t.modified.startLineNumber -
                  e.modified.endLineNumberExclusive &&
              e.original.endLineNumberExclusive < t.original.startLineNumber &&
              e.modified.endLineNumberExclusive < t.modified.startLineNumber
          );
        }),
        r
    ...
    class Ar {
      constructor(e, t, n, i = 1) {
        (this._rgbaBrand = void 0),
          ...
          (this.a = Rr(Math.max(Math.min(1, i), 0), 3));
      }
      static equals(e, t) {
    ...
    class xr {
      constructor(e, t, n, i) {
        (this._hslaBrand = void 0),
          ...
          (this.s = Rr(Math.max(Math.min(1, t), 0), 3)),
          (this.l = Rr(Math.max(Math.min(1, n), 0), 3)),
          (this.a = Rr(Math.max(Math.min(1, i), 0), 3));
      }
      static equals(e, t) {
      ...
      static fromRGBA(e) {
        ...
        if (h > 0) {
          switch (
            ((l = Math.min(u <= 0.5 ? h / (2 * u) : h / (2 - 2 * u), 1)), s)
          ) {
            case t:
              a = (n - i) / h + (n < i ? 6 : 0);
              break;
      ...
      static toRGBA(e) {
        ...
        if (0 === n) s = o = a = i;
          ...
          const e = i < 0.5 ? i * (1 + n) : i + n - i * n,
            r = 2 * i - e;
          (s = xr._hue2rgb(r, e, t + 1 / 3)),
            (o = xr._hue2rgb(r, e, t)),
            (a = xr._hue2rgb(r, e, t - 1 / 3));
        }
        return new Ar(
          Math.round(255 * s),
          Math.round(255 * o),
    ...
    class Mr {
      constructor(e, t, n, i) {
        (this._hsvaBrand = void 0),
          (this.h = 0 | Math.max(Math.min(360, e), 0)),
          (this.s = Rr(Math.max(Math.min(1, t), 0), 3)),
          (this.v = Rr(Math.max(Math.min(1, n), 0), 3)),
          (this.a = Rr(Math.max(Math.min(1, i), 0), 3));
      }
      static equals(e, t) {
            ...
            0 === s
              ...
              : r === t
                ...
                : r === n
                  ? (i - t) / s + 2
                  : (t - n) / s + 4),
          new Mr(Math.round(60 * a), o, r, e.a)
        );
      }
      static toRGBA(e) {
    ...
    class kr {
      static fromHex(e) {
        return kr.Format.CSS.parseHex(e) || kr.red;
      }
      static equals(e, t) {
        return (!e && !t) || (!(!e || !t) && e.equals(t));
      }
      get hsla() {
        return this._hsla ? this._hsla : xr.fromRGBA(this.rgba);
      }
      get hsva() {
        return this._hsva ? this._hsva : Mr.fromRGBA(this.rgba);
      }
      constructor(e) {
        if (!e) throw new Error('Color needs a value');
        if (e instanceof Ar) this.rgba = e;
        else if (e instanceof xr) (this._hsla = e), (this.rgba = xr.toRGBA(e));
        else {
          if (!(e instanceof Mr))
            throw new Error('Invalid color ctor argument');
          (this._hsva = e), (this.rgba = Mr.toRGBA(e));
        }
      }
      equals(e) {
        return (
          !!e &&
          Ar.equals(this.rgba, e.rgba) &&
          xr.equals(this.hsla, e.hsla) &&
          Mr.equals(this.hsva, e.hsva)
        );
      }
      getRelativeLuminance() {
        return Rr(
          0.2126 * kr._relativeLuminanceForComponent(this.rgba.r) +
            0.7152 * kr._relativeLuminanceForComponent(this.rgba.g) +
            0.0722 * kr._relativeLuminanceForComponent(this.rgba.b),
          4
        );
      }
      ...
      transparent(e) {
        ...
        return new kr(new Ar(t, n, i, r * e));
      }
      isTransparent() {
      ...
      toString() {
        return (
          this._toString || (this._toString = kr.Format.CSS.format(this)),
          this._toString
        );
      }
    ...
    function Pr(e, t) {
      if (!e) return;
      const n = kr.Format.CSS.parseHex(t);
      return n
        ? { range: e, color: Or(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a) }
        : void 0;
    }
    function Dr(e, t, n) {
      if (!e || 1 !== t.length) return;
      const i = Tr(t[0].values());
      return { range: e, color: Or(i[0], i[1], i[2], n ? i[3] : 1) };
    }
    function Fr(e, t, n) {
      if (!e || 1 !== t.length) return;
      const i = Tr(t[0].values()),
        r = new kr(new xr(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
      return { range: e, color: Or(r.rgba.r, r.rgba.g, r.rgba.b, r.rgba.a) };
    }
    function Kr(e, t) {
      return 'string' == typeof e ? [...e.matchAll(t)] : e.findMatches(t);
    }
    (kr.white = new kr(new Ar(255, 255, 255, 1))),
      (kr.black = new kr(new Ar(0, 0, 0, 1))),
      (kr.red = new kr(new Ar(255, 0, 0, 1))),
      (kr.blue = new kr(new Ar(0, 0, 255, 1))),
      (kr.green = new kr(new Ar(0, 255, 0, 1))),
      (kr.cyan = new kr(new Ar(0, 255, 255, 1))),
      (kr.lightgrey = new kr(new Ar(211, 211, 211, 1))),
      (kr.transparent = new kr(new Ar(0, 0, 0, 0))),
      (function (e) {
        let t;
        !(function (t) {
          let n;
            ...
            (t.formatRGB = function (t) {
              ...
              (t.parseHex = function (t) {
                ...
                if (9 === n) {
                  ...
                  return new e(new Ar(n, r, s, o / 255));
                }
                if (4 === n) {
                  const n = i(t.charCodeAt(1)),
                    r = i(t.charCodeAt(2)),
                    s = i(t.charCodeAt(3));
                  return new e(new Ar(16 * n + n, 16 * r + r, 16 * s + s));
                }
                if (5 === n) {
                  const n = i(t.charCodeAt(1)),
                    r = i(t.charCodeAt(2)),
    ...
    function Br(e, t, n) {
      ...
      if (i) {
        ...
        if (e.endColumn > e.startColumn) {
          const t = { range: e, ...Ur(i[1]), shouldBeInComments: !0 };
    ...
    function Ur(e) {
      ...
      return { text: (e = e.replace(Vr, '')), hasSeparatorLine: t };
    }
    class Hr extends It {
      get uri() {
        return this._uri;
      ...
      findMatches(e) {
        ...
        for (let n = 0; n < this._lines.length; n++) {
          const i = this._lines[n],
            r = this.offsetAt(new Nt(n + 1, 1)),
            s = i.matchAll(e);
          for (const e of s)
            (e.index || 0 === e.index) && (e.index = e.index + r), t.push(e);
        }
        return t;
      }
      getLinesContent() {
      ...
      getWordAtPosition(e, t) {
        const n = Kt(e.column, Dt(t), this._lines[e.lineNumber - 1], 0);
        return n
    ...
    class Wr {
      ...
      async computeUnicodeHighlights(e, t, n) {
        ...
        return i
          ? Mi.computeUnicodeHighlights(i, t, n)
          : {
              ranges: [],
              hasMore: !1,
        ...
        return n
          ? (function (e, t) {
              ...
              if (
                ...
                (null === (n = t.foldingRules) || void 0 === n
                  ? void 0
                  : n.markers)
              ) {
              ...
              if (t.findMarkSectionHeaders) {
                const t = (function (e) {
                  const t = [],
                    n = e.getLineCount();
                  for (let i = 1; i <= n; i++) Br(e.getLineContent(i), i, t);
                  return t;
                })(e);
                i = i.concat(t);
              }
      ...
      async computeDiff(e, t, n, i) {
        const r = this._getModel(e),
          s = this._getModel(t);
        return r && s ? Wr.computeDiff(r, s, n, i) : null;
      }
      static computeDiff(e, t, n, i) {
        const r = 'advanced' === i ? new Er() : new zi(),
          s = e.getLinesContent(),
          o = t.getLinesContent(),
      ...
      async computeMoreMinimalEdits(e, t, n) {
        ...
        t = t
          ...
          .sort((e, t) =>
            e.range && t.range
              ? Et.compareRangesUsingStarts(e.range, t.range)
              : (e.range ? 0 : 1) - (t.range ? 0 : 1)
          );
        let o = 0;
        for (let e = 1; e < t.length; e++)
          Et.getEndPosition(t[o].range).equals(Et.getStartPosition(t[e].range))
            ? ((t[o].range = Et.fromPositions(
                Et.getStartPosition(t[o].range),
                Et.getEndPosition(t[e].range)
              )),
              (t[o].text += t[e].text))
            : (o++, (t[o] = t[e]));
        t.length = o + 1;
        for (let { range: e, text: o, eol: a } of t) {
          if (('number' == typeof a && (s = a), Et.isEmpty(e) && !o)) continue;
          const t = i.getValueInRange(e);
          if (((o = o.replace(/\r\n|\n|\r/g, i.eol)), t === o)) continue;
          if (Math.max(o.length, t.length) > Wr._diffLimit) {
            r.push({ range: e, text: o });
            continue;
          }
          const l = Pe(t, o, n),
            u = i.offsetAt(Et.lift(e).getStartPosition());
          for (const e of l) {
            const t = i.positionAt(u + e.originalStart),
              n = i.positionAt(u + e.originalStart + e.originalLength),
              s = {
            ...
            i.getValueInRange(s.range) !== s.text && r.push(s);
          }
        }
        return (
          'number' == typeof s &&
          ...
          if (e)
            for (const n of e.words(s))
              if (
                n !== t &&
                isNaN(Number(n)) &&
                (o.add(n), o.size > Wr._suggestionsLimit)
              )
                break e;
        }
      ...
      async navigateValueSet(e, t, n, i, r) {
        ...
        return $t.INSTANCE.navigateValueSet(t, a, l, u, n);
      }
          ...
          CancellationTokenSource: class {
            ...
            cancel() {
              this._token
                ...
                : (this._token = Gt.Cancelled);
            }
            dispose(e = !1) {
              var t;
              e && this.cancel(),
                null === (t = this._parentListener) ||
                  void 0 === t ||
                  t.dispose(),
                this._token
