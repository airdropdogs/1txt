  ...
  [90],
  {
    52659: function (t) {
      !(function (r) {
        ...
        var a = [
          function (t, r, n) {
            return r < 60 || (13311 < r && r < 42607) ? new o(r, e) : t(r, n);
          },
          function (t, r, e) {
            var n = s[r];
            return (
          ...
          function (t, r, e) {
            ...
            if (i <= r && r < 4371) {
              var u = {},
                f = 21 * (r - i);
              for (s = 0; s < 21; ++s) u[4449 + s] = n + 28 * (s + f);
              return new o(r, [, , u]);
            }
            var a = r - n,
              h = a % 28,
          ...
          function (t, r, n) {
            var i = (o.udata[65280 & r] || {})[r];
            return new o(r, i || e);
          },
        ];
        (o.fromCharCode = a.reduceRight(function (t, r) {
          return function (e, n) {
            return r(t, e, n);
          };
        }, null)),
          ...
          for (
            var e,
              n = (function (t, r) {
                switch (t) {
                  case 'NFD':
                    return new l(new c(new h(r), !0));
                  case 'NFKD':
                    return new l(new c(new h(r), !1));
                  case 'NFC':
                    return new p(new l(new c(new h(r), !0)));
                  case 'NFKC':
                    return new p(new l(new c(new h(r), !1)));
                }
                throw t + ' is invalid';
              })(t, r),
              i = '';
          ...
          String.prototype.normalize ||
            (Object.defineProperty(String.prototype, 'normalize', {
              ...
              value: function () {
                ...
                if ('NFC' === r) return g.nfc(t);
                if ('NFD' === r) return g.nfd(t);
                if ('NFKC' === r) return g.nfkc(t);
                if ('NFKD' === r) return g.nfkd(t);
