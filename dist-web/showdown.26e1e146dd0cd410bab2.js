/*! For license information please see showdown.26e1e146dd0cd410bab2.js.LICENSE.txt */
(self.webpackChunk = self.webpackChunk || []).push([
  [6632],
  {
    79132: function (e, r, t) {
      var a;
      (function () {
        function n(e) {
          'use strict';
        ...
        function d(e, r) {
          ...
          for (var n = 0; n < e.length; ++n) {
            var o = t + ' sub-extension ' + n + ': ',
              i = e[n];
            if ('object' != typeof i)
              return (
                (a.valid = !1),
                (a.error = o + 'must be an object, but ' + typeof i + ' given'),
                a
              );
            if (!s.helper.isString(i.type))
              return (
                (a.valid = !1),
                (a.error =
                  o +
            ...
            if ('listener' === l) {
              if (s.helper.isUndefined(i.listeners))
                return (
                  (a.valid = !1),
                  (a.error =
                    o +
              ...
              s.helper.isUndefined(i.filter) &&
              s.helper.isUndefined(i.regex)
            )
              return (
                (a.valid = !1),
                (a.error =
            ...
            if (i.filter) {
              ...
              if (s.helper.isUndefined(i.replace))
                return (
                  (a.valid = !1),
                  (a.error =
                    o +
        ...
        (s.helper = {}),
          ...
          (s.setFlavor = function (e) {
            ...
            s.resetOptions();
            var r = u[e];
            for (var t in ((c = e), r)) r.hasOwnProperty(t) && (l[t] = r[t]);
          }),
          ...
          (s.extension = function (e, r) {
            'use strict';
            if (!s.helper.isString(e))
              throw Error("Extension 'name' must be a string");
            if (((e = s.helper.stdExtName(e)), s.helper.isUndefined(r))) {
              if (!i.hasOwnProperty(e))
                throw Error('Extension named ' + e + ' is not registered!');
              return i[e];
            }
            'function' == typeof r && (r = r()),
              s.helper.isArray(r) || (r = [r]);
            var t = d(r, e);
          ...
          (s.helper.forEach = function (e, r) {
            'use strict';
            if (s.helper.isUndefined(e))
              throw new Error('obj param is required');
            if (s.helper.isUndefined(r))
          ...
          (s.helper.escapeCharactersCallback = p),
          (s.helper.escapeCharacters = function (e, r, t) {
            'use strict';
            var a = '([' + r.replace(/([\[\]\\])/g, '\\$1') + '])';
            t && (a = '\\\\' + a);
        ...
        (s.helper.matchRecursiveRegExp = function (e, r, t, a) {
          'use strict';
          for (var n = h(e, r, t, a), s = [], o = 0; o < n.length; ++o)
            s.push([
          ...
          (s.helper.replaceRecursiveRegExp = function (e, r, t, a, n) {
            'use strict';
            if (!s.helper.isFunction(r)) {
              var o = r;
              r = function () {
            ...
            if (c > 0) {
              ...
              0 !== i[0].wholeMatch.start &&
                u.push(e.slice(0, i[0].wholeMatch.start));
              for (var d = 0; d < c; ++d)
                u.push(
                  r(
                    e.slice(i[d].wholeMatch.start, i[d].wholeMatch.end),
                    e.slice(i[d].match.start, i[d].match.end),
                    e.slice(i[d].left.start, i[d].left.end),
                    e.slice(i[d].right.start, i[d].right.end)
                  )
                ),
                  d < c - 1 &&
                    u.push(
                      e.slice(i[d].wholeMatch.end, i[d + 1].wholeMatch.start)
                    );
              i[c - 1].wholeMatch.end < e.length &&
                u.push(e.slice(i[c - 1].wholeMatch.end)),
                (l = u.join(''));
            }
            return l;
          }),
          (s.helper.regexIndexOf = function (e, r, t) {
            'use strict';
            if (!s.helper.isString(e))
              throw 'InvalidArgumentError: first parameter of showdown.helper.regexIndexOf function must be a string';
            if (r instanceof RegExp == 0)
              throw 'InvalidArgumentError: second parameter of showdown.helper.regexIndexOf function must be an instance of RegExp';
            var a = e.substring(t || 0).search(r);
            return a >= 0 ? a + (t || 0) : a;
          }),
          (s.helper.splitAtIndex = function (e, r) {
            'use strict';
            if (!s.helper.isString(e))
              throw 'InvalidArgumentError: first parameter of showdown.helper.regexIndexOf function must be a string';
          ...
          (s.helper.padEnd = function (e, r, t) {
            'use strict';
            return (
              (r |= 0),
              (t = String(t || ' ')),
          ...
          (s.helper.regexes = { asteriskDashAndColon: /([*_:~])/g }),
          (s.helper.emojis = {
            '+1': '👍',
            '-1': '👎',
            100: '💯',
          ...
          (s.Converter = function (e) {
            ...
            var r = {},
              ...
              p = { parsed: {}, raw: '', format: '' };
            function h(e, r) {
              if (((r = r || null), s.helper.isString(e))) {
                if (((r = e = s.helper.stdExtName(e)), s.extensions[e]))
                  return (
                    console.warn(
                      'DEPRECATION WARNING: ' +
                        e +
              ...
              for (var o = 0; o < e.length; ++o) {
                ...
                if (e[o].hasOwnProperty('listeners'))
                  for (var l in e[o].listeners)
                    e[o].listeners.hasOwnProperty(l) && _(l, e[o].listeners[l]);
              }
            }
            function _(e, r) {
              if (!s.helper.isString(e))
            ...
            !(function () {
              ...
              r.extensions && s.helper.forEach(r.extensions, h);
            })(),
              (this._dispatch = function (e, r, t, a) {
                if (n.hasOwnProperty(e))
                  for (var s = 0; s < n[e].length; ++s) {
                    var o = n[e][s](e, r, this, t, a);
                    o && void 0 !== o && (r = o);
                  }
                return r;
              }),
              ...
              (this.makeHtml = function (e) {
                ...
                return (
                  ...
                  (e = '\n\n' + e + '\n\n'),
                  (e = (e = s.subParser('detab')(e, r, n)).replace(
                    /^[ \t]+$/gm,
                    ''
                  )),
                  s.helper.forEach(t, function (t) {
                    e = s.subParser('runExtension')(t, e, r, n);
                  }),
                  (e = s.subParser('metadata')(e, r, n)),
                  (e = s.subParser('hashPreCodeTags')(e, r, n)),
                  (e = s.subParser('githubCodeBlocks')(e, r, n)),
                  (e = s.subParser('hashHTMLBlocks')(e, r, n)),
                  (e = s.subParser('hashCodeTags')(e, r, n)),
                  (e = s.subParser('stripLinkDefinitions')(e, r, n)),
                  (e = s.subParser('blockGamut')(e, r, n)),
                  (e = s.subParser('unhashHTMLSpans')(e, r, n)),
                  (e = (e = (e = s.subParser('unescapeSpecialChars')(
                    e,
                    r,
                    n
                  )).replace(/¨D/g, '$$')).replace(/¨T/g, '¨')),
                  (e = s.subParser('completeHTMLDocument')(e, r, n)),
                  s.helper.forEach(a, function (t) {
                    e = s.subParser('runExtension')(t, e, r, n);
                  }),
                  (p = n.metadata),
                  e
              ...
              (this.makeMarkdown = this.makeMd =
                function (e, r) {
                    ...
                    preList: (function (e) {
                      for (
                        ...
                        if (
                          ...
                          if ('' === o)
                            for (
                              var i = r[a].firstChild.className.split(' '),
                                l = 0;
                              l < i.length;
                              ++l
                            ) {
                          ...
                          (n = s.helper.unescapeHTMLEntities(n)),
                            t.push(n),
                            (r[a].outerHTML =
                              '<precode language="' +
                              o +
                  ...
                  for (var n = t.childNodes, o = '', i = 0; i < n.length; i++)
                    o += s.subParser('makeMarkdown.node')(n[i], a);
                  return o;
                }),
          ...
          s.subParser('anchors', function (e, r, t) {
            ...
            var a = function (e, a, n, o, i, l, c) {
              if (
                ...
                if (
                  (n || (n = a.toLowerCase().replace(/ ?\n/g, ' ')),
                  (o = '#' + n),
                  s.helper.isUndefined(t.gUrls[n]))
                )
                  return e;
                (o = t.gUrls[n]),
                  s.helper.isUndefined(t.gTitles[n]) || (c = t.gTitles[n]);
              }
              var u =
                '<a href="' +
                (o = o.replace(
                  s.helper.regexes.asteriskDashAndColon,
                  s.helper.escapeCharactersCallback
                )) +
                '"';
              return (
                '' !== c &&
            ...
            return (
              ...
              r.ghMentions &&
                (e = e.replace(
                  ...
                  function (e, t, a, n, o) {
                    if ('\\' === a) return t + n;
                    if (!s.helper.isString(r.ghMentionsLink))
        ...
        var _ =
          ...
          k = function (e, r) {
            ...
            return function (t, a, n) {
              ...
              return (
                (a = a || ''),
                (n = s.subParser('unescapeSpecialChars')(n, e, r)),
                e.encodeEmails
                  ? ((o = s.helper.encodeEmailAddress(o + n)),
                    (n = s.helper.encodeEmailAddress(n)))
                  : (o += n),
                a + '<a href="' + o + '">' + n + '</a>'
              );
            };
        ...
        s.subParser('autoLinks', function (e, r, t) {
          ...
          return (
            (e = (e = (e = t.converter._dispatch(
              ...
              r,
              t
            )).replace(m, w(r))).replace(b, k(r, t))),
            t.converter._dispatch('autoLinks.after', e, r, t)
          );
        }),
          s.subParser('simplifiedAutoLinks', function (e, r, t) {
            'use strict';
            return r.simplifiedAutoLink
              ? ((e = t.converter._dispatch(
                ...
                (e = (e = r.excludeTrailingPunctuationFromURLs
                  ? e.replace(g, w(r))
                  : e.replace(_, w(r))).replace(f, k(r, t))),
                (e = t.converter._dispatch(
          ...
          s.subParser('blockGamut', function (e, r, t) {
            ...
            return (
              ...
              (e = s.subParser('horizontalRule')(e, r, t)),
            ...
            return (
              ...
              (e = e.replace(a, function (e) {
                return (
                  ...
                  (e = s.subParser('githubCodeBlocks')(e, r, t)),
                  (e = (e = (e = s.subParser('blockGamut')(e, r, t)).replace(
                    /(^|\n)/g,
                    '$1  '
          ...
          s.subParser('codeBlocks', function (e, r, t) {
            ...
            return (
              ...
              (e = (e = (e += '¨0').replace(
                ...
                function (e, a, n) {
                  var o = a,
                    ...
                    l = '\n';
                  return (
                    (o = s.subParser('outdent')(o, r, t)),
                    (o = s.subParser('encodeCode')(o, r, t)),
              ...
              t.converter._dispatch('codeBlocks.after', e, r, t)
            );
          }),
                ...
                function (e, a, n, o) {
                  ...
                  return (
                    ...
                    (i =
                      a +
                      '<code>' +
                      (i = s.subParser('encodeCode')(i, r, t)) +
                      '</code>'),
                    s.subParser('hashHTMLSpans')(i, r, t)
                  );
                }
              )),
          ...
          s.subParser('completeHTMLDocument', function (e, r, t) {
            'use strict';
            ...
            return (
              (e =
                ...
                e.trim() +
                '\n</body>\n</html>'),
              t.converter._dispatch('completeHTMLDocument.after', e, r, t)
            );
          }),
          s.subParser('detab', function (e, r, t) {
            'use strict';
            return (
          ...
          s.subParser('ellipsis', function (e, r, t) {
            'use strict';
            return r.ellipsis
          ...
          s.subParser('emoji', function (e, r, t) {
            'use strict';
            return r.emoji
              ? ((e = (e = t.converter._dispatch(
                  'emoji.before',
                  ...
                  return s.helper.emojis.hasOwnProperty(r)
                    ? s.helper.emojis[r]
                    : e;
                })),
                t.converter._dispatch('emoji.after', e, r, t))
              : e;
          }),
          s.subParser('encodeAmpsAndAngles', function (e, r, t) {
            'use strict';
            return (
              (e = (e = (e = (e = (e = t.converter._dispatch(
          ...
          s.subParser('encodeBackslashEscapes', function (e, r, t) {
            'use strict';
            return (
              (e = (e = (e = t.converter._dispatch(
                ...
                r,
                t
              )).replace(/\\(\\)/g, s.helper.escapeCharactersCallback)).replace(
                /\\([`*_{}\[\]()>#+.!~=|:-])/g,
                s.helper.escapeCharactersCallback
              )),
          ...
          s.subParser('encodeCode', function (e, r, t) {
            'use strict';
            return (
          ...
          s.subParser('hashCodeTags', function (e, r, t) {
            'use strict';
            return (
              ...
              (e = s.helper.replaceRecursiveRegExp(
                e,
                function (e, a, n, o) {
                  var i = n + s.subParser('encodeCode')(a, r, t) + o;
              ...
              t.converter._dispatch('hashCodeTags.after', e, r, t)
            );
          }),
            ...
            for (var o = 0; o < a.length; ++o)
              for (
                var i,
                  ...
                  c = '<' + a[o] + '\\b[^>]*>',
                  u = '</' + a[o] + '>';
                -1 !== (i = s.helper.regexIndexOf(e, l));

              ) {
                var d = s.helper.splitAtIndex(e, i),
                  p = s.helper.replaceRecursiveRegExp(d[1], n, c, u, 'im');
                if (p === d[1]) break;
                e = d[0].concat(p);
              }
            return (
              (e = e.replace(
                /(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,
                s.subParser('hashElement')(e, r, t)
              )),
              (e = (e = s.helper.replaceRecursiveRegExp(
                e,
                function (e) {
                  return '\n\n¨K' + (t.gHtmlBlocks.push(e) - 1) + 'K\n\n';
                },
              ...
              t.converter._dispatch('hashHTMLBlocks.after', e, r, t)
            );
          }),
          ...
          s.subParser('hashPreCodeTags', function (e, r, t) {
            ...
            return (
              ...
              t.converter._dispatch('hashPreCodeTags.after', e, r, t)
            );
          }),
          s.subParser('headers', function (e, r, t) {
            'use strict';
            e = t.converter._dispatch('headers.before', e, r, t);
            var a = isNaN(parseInt(r.headerLevelStart))
                ? 1
                : parseInt(r.headerLevelStart),
              n = r.smoothLivePreview
                ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm
                : /^(.+)[ \t]*\n=+[ \t]*\n+/gm,
              o = r.smoothLivePreview
                ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm
                : /^(.+)[ \t]*\n-+[ \t]*\n+/gm;
            e = (e = e.replace(n, function (e, n) {
              var o = s.subParser('spanGamut')(n, r, t),
                i = r.noHeaderId ? '' : ' id="' + l(n) + '"',
                c = '<h' + a + i + '>' + o + '</h' + a + '>';
              return s.subParser('hashBlock')(c, r, t);
            ...
            function l(e) {
              ...
              return (
                (a = e),
                (n = s.helper.isString(r.prefixHeaderId)
                  ? r.prefixHeaderId
                  : !0 === r.prefixHeaderId
                    ? 'section-'
                    : ''),
                r.rawPrefixHeaderId || (a = n + a),
                ...
                r.rawPrefixHeaderId && (a = n + a),
                t.hashLinkCounts[a]
                  ? (a = a + '-' + t.hashLinkCounts[a]++)
                  : (t.hashLinkCounts[a] = 1),
                a
              );
            }
            return (
              (e = e.replace(i, function (e, n, o) {
                var i = o;
                r.customizedHeaderId &&
                  (i = o.replace(/\s?\{([^{]+?)}\s*$/, ''));
                var c = s.subParser('spanGamut')(i, r, t),
          ...
          s.subParser('horizontalRule', function (e, r, t) {
            'use strict';
            e = t.converter._dispatch('horizontalRule.before', e, r, t);
            var a = s.subParser('hashBlock')('<hr />', r, t);
            return (
          ...
          s.subParser('images', function (e, r, t) {
            ...
            function a(e, r, a, n, o, i, l, c) {
              ...
              if (
                ...
                if (
                  (('' !== a && null !== a) ||
                    (a = r.toLowerCase().replace(/ ?\n/g, ' ')),
                  (n = '#' + a),
                  s.helper.isUndefined(u[a]))
                )
                  return e;
                (n = u[a]),
                  s.helper.isUndefined(d[a]) || (c = d[a]),
                  s.helper.isUndefined(p[a]) ||
                    ((o = p[a].width), (i = p[a].height));
              }
              r = r
                .replace(/"/g, '&quot;')
                .replace(
            ...
            return (
              (e = (e = (e = (e = (e = (e = t.converter._dispatch(
                ...
                function (e, r, t, n, s, o, i, l) {
                  return a(e, r, t, (n = n.replace(/\s/g, '')), s, o, 0, l);
                }
              )).replace(
                /!\[([^\]]*?)][ \t]*()\([ \t]?<([^>]*)>(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(?:(["'])([^"]*?)\6))?[ \t]?\)/g,
                a
          ...
          s.subParser('lists', function (e, r, t) {
            ...
            function a(e, a) {
              ...
              return (
                r.disableForced4SpacesIndentedSublists &&
                  (n =
                    /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0|\2([*+-]|\d+[.])[ \t]+))/gm),
                (e = (e = e.replace(n, function (e, a, n, i, l, c, u) {
                  u = u && '' !== u.trim();
                  var d = s.subParser('outdent')(l, r, t),
                    p = '';
                  return (
                    c &&
                      r.tasklists &&
                    ...
                    a || d.search(/\n{2,}/) > -1
                      ? ((d = s.subParser('githubCodeBlocks')(d, r, t)),
                        (d = s.subParser('blockGamut')(d, r, t)))
                      : ((d = (d = s.subParser('lists')(d, r, t)).replace(
                          /\n$/,
                          ''
                        )),
                        (d = (d = s.subParser('hashHTMLBlocks')(
                          d,
                          r,
                          t
                        )).replace(/\n\n+/g, '\n\n')),
                        (d = o
                          ? s.subParser('paragraphs')(d, r, t)
                          : s.subParser('spanGamut')(d, r, t))),
            ...
            return (
              ...
              t.converter._dispatch('lists.after', e, r, t)
            );
          }),
          s.subParser('metadata', function (e, r, t) {
            'use strict';
            ...
            return (
              ...
              t.converter._dispatch('metadata.after', e, r, t)
            );
          }),
          s.subParser('outdent', function (e, r, t) {
            'use strict';
            return (
              (e = (e = (e = t.converter._dispatch(
                'outdent.before',
          ...
          s.subParser('paragraphs', function (e, r, t) {
            ...
            for (
              ...
              l.search(/¨(K|G)(\d+)\1/g) >= 0
                ? n.push(l)
                : l.search(/\S/) >= 0 &&
                  ((l = (l = s.subParser('spanGamut')(l, r, t)).replace(
                    /^([ \t]*)/g,
                    '<p>'
                  )),
                  (l += '</p>'),
            ...
            for (o = n.length, i = 0; i < o; i++) {
              for (var c = '', u = n[i], d = !1; /¨(K|G)(\d+)\1/.test(u); ) {
                var p = RegExp.$1,
                  h = RegExp.$2;
                (c = (c =
                  'K' === p
                    ? t.gHtmlBlocks[h]
                    : d
                      ? s.subParser('encodeCode')(t.ghCodeBlocks[h].text, r, t)
          ...
          s.subParser('runExtension', function (e, r, t, a) {
            'use strict';
          ...
          s.subParser('spanGamut', function (e, r, t) {
            ...
            return (
              ...
              (e = s.subParser('escapeSpecialCharsWithinTagAttributes')(
                e,
                r,
                t
              )),
              ...
              (e = s.subParser('simplifiedAutoLinks')(e, r, t)),
              (e = s.subParser('emoji')(e, r, t)),
              (e = s.subParser('underline')(e, r, t)),
              (e = s.subParser('italicsAndBold')(e, r, t)),
              (e = s.subParser('strikethrough')(e, r, t)),
              (e = s.subParser('ellipsis')(e, r, t)),
              (e = s.subParser('hashHTMLSpans')(e, r, t)),
          ...
          s.subParser('stripLinkDefinitions', function (e, r, t) {
            'use strict';
            var a = function (a, n, o, i, l, c, u) {
              return (
                (n = n.toLowerCase()),
                e.toLowerCase().split(n).length - 1 < 2
                  ? a
                  : (o.match(/^data:.+?\/.+?;base64,/)
                      ? (t.gUrls[n] = o.replace(/\s/g, ''))
                      : (t.gUrls[n] = s.subParser('encodeAmpsAndAngles')(
                          o,
                          r,
                          t
                        )),
                    c
                      ? c + u
                      : (u && (t.gTitles[n] = u.replace(/"|'/g, '&quot;')),
                        r.parseImgDimensions &&
                          i &&
                          l &&
                          (t.gDimensions[n] = { width: i, height: l }),
                        ''))
              );
            };
          ...
          s.subParser('tables', function (e, r, t) {
            ...
            function a(e, a) {
              return (
                '<td' + a + '>' + s.subParser('spanGamut')(e, r, t) + '</td>\n'
              );
            }
            function n(e) {
              var n,
              ...
              for (n = 0; n < o.length; ++n)
                /^ {0,3}\|/.test(o[n]) &&
                  ...
                  /\|[ \t]*$/.test(o[n]) &&
                    (o[n] = o[n].replace(/\|[ \t]*$/, '')),
                  (o[n] = s.subParser('codeSpans')(o[n], r, t));
              var i,
                l,
                c,
                u,
                ...
                g = [],
                m = [];
              for (o.shift(), o.shift(), n = 0; n < o.length; ++n)
                '' !== o[n].trim() &&
                  h.push(
                ...
                s.helper.isUndefined(g[n]) && (g[n] = ''),
                  _.push(
                    ...
                    '<th' +
                      ...
                      c +
                      '>' +
                      (l = s.subParser('spanGamut')(l, r, t)) +
                      '</th>\n')
                  );
              for (n = 0; n < h.length; ++n) {
                for (var f = [], b = 0; b < _.length; ++b)
                  s.helper.isUndefined(h[n][b]), f.push(a(h[n][b], g[b]));
                m.push(f);
              }
              return (function (e, r) {
                for (
          ...
          s.subParser('underline', function (e, r, t) {
            'use strict';
            return r.underline
              ? ((e = t.converter._dispatch('underline.before', e, r, t)),
                (e = (e = r.literalMidWordUnderscores
                  ...
                  : (e = e.replace(/___(\S[\s\S]*?)___/g, function (e, r) {
                      ...
                      return /\S$/.test(r) ? '<u>' + r + '</u>' : e;
                    })).replace(/(_)/g, s.helper.escapeCharactersCallback)),
                (e = t.converter._dispatch('underline.after', e, r, t)))
              : e;
          }),
          s.subParser('unescapeSpecialChars', function (e, r, t) {
            'use strict';
            return (
              (e = (e = t.converter._dispatch(
          ...
          s.subParser('makeMarkdown.blockquote', function (e, r) {
            'use strict';
            var t = '';
            if (e.hasChildNodes())
              for (var a = e.childNodes, n = a.length, o = 0; o < n; ++o) {
                var i = s.subParser('makeMarkdown.node')(a[o], r);
                '' !== i && (t += i);
              }
            return '> ' + (t = t.trim()).split('\n').join('\n> ');
          }),
          s.subParser('makeMarkdown.codeBlock', function (e, r) {
            'use strict';
          ...
          s.subParser('makeMarkdown.emphasis', function (e, r) {
            'use strict';
            var t = '';
            if (e.hasChildNodes()) {
              t += '*';
              for (var a = e.childNodes, n = a.length, o = 0; o < n; ++o)
                t += s.subParser('makeMarkdown.node')(a[o], r);
              t += '*';
            }
            return t;
          }),
          s.subParser('makeMarkdown.header', function (e, r, t) {
            'use strict';
            ...
            if (e.hasChildNodes()) {
              ...
              for (var o = e.childNodes, i = o.length, l = 0; l < i; ++l)
                n += s.subParser('makeMarkdown.node')(o[l], r);
            }
            return n;
          }),
          ...
          s.subParser('makeMarkdown.links', function (e, r) {
            'use strict';
            var t = '';
          ...
          s.subParser('makeMarkdown.list', function (e, r, t) {
            'use strict';
            var a = '';
            ...
            for (
              ...
              void 0 !== n[l].tagName &&
                'li' === n[l].tagName.toLowerCase() &&
                ((a +=
                  ('ol' === t ? i.toString() + '. ' : '- ') +
                  s.subParser('makeMarkdown.listItem')(n[l], r)),
                ++i);
            return (a += '\n\x3c!-- --\x3e\n').trim();
          }),
          s.subParser('makeMarkdown.listItem', function (e, r) {
            'use strict';
            for (var t = '', a = e.childNodes, n = a.length, o = 0; o < n; ++o)
              t += s.subParser('makeMarkdown.node')(a[o], r);
            return (
              /\n$/.test(t)
                ? (t = t
          ...
          s.subParser('makeMarkdown.node', function (e, r, t) {
            'use strict';
            t = t || !1;
            var a = '';
            if (3 === e.nodeType) return s.subParser('makeMarkdown.txt')(e, r);
            if (8 === e.nodeType) return '\x3c!--' + e.data + '--\x3e\n\n';
            if (1 !== e.nodeType) return '';
            switch (e.tagName.toLowerCase()) {
              case 'h1':
                t || (a = s.subParser('makeMarkdown.header')(e, r, 1) + '\n\n');
                break;
              case 'h2':
                t || (a = s.subParser('makeMarkdown.header')(e, r, 2) + '\n\n');
                break;
              case 'h3':
                t || (a = s.subParser('makeMarkdown.header')(e, r, 3) + '\n\n');
                break;
              case 'h4':
                t || (a = s.subParser('makeMarkdown.header')(e, r, 4) + '\n\n');
                break;
              case 'h5':
                t || (a = s.subParser('makeMarkdown.header')(e, r, 5) + '\n\n');
                break;
              case 'h6':
                t || (a = s.subParser('makeMarkdown.header')(e, r, 6) + '\n\n');
                break;
              case 'p':
                t || (a = s.subParser('makeMarkdown.paragraph')(e, r) + '\n\n');
                break;
              case 'blockquote':
                t ||
                  (a = s.subParser('makeMarkdown.blockquote')(e, r) + '\n\n');
                break;
              case 'hr':
                t || (a = s.subParser('makeMarkdown.hr')(e, r) + '\n\n');
                break;
              case 'ol':
                t ||
                  (a = s.subParser('makeMarkdown.list')(e, r, 'ol') + '\n\n');
                break;
              case 'ul':
                t ||
                  (a = s.subParser('makeMarkdown.list')(e, r, 'ul') + '\n\n');
                break;
              case 'precode':
                t || (a = s.subParser('makeMarkdown.codeBlock')(e, r) + '\n\n');
                break;
              case 'pre':
                t || (a = s.subParser('makeMarkdown.pre')(e, r) + '\n\n');
                break;
              case 'table':
                t || (a = s.subParser('makeMarkdown.table')(e, r) + '\n\n');
                break;
              case 'code':
                a = s.subParser('makeMarkdown.codeSpan')(e, r);
                break;
              case 'em':
              case 'i':
                a = s.subParser('makeMarkdown.emphasis')(e, r);
                break;
              case 'strong':
              case 'b':
                a = s.subParser('makeMarkdown.strong')(e, r);
                break;
              case 'del':
                a = s.subParser('makeMarkdown.strikethrough')(e, r);
                break;
              case 'a':
                a = s.subParser('makeMarkdown.links')(e, r);
                break;
              case 'img':
                a = s.subParser('makeMarkdown.image')(e, r);
                break;
              default:
                a = e.outerHTML + '\n\n';
            }
          ...
          s.subParser('makeMarkdown.paragraph', function (e, r) {
            'use strict';
            var t = '';
            if (e.hasChildNodes())
              for (var a = e.childNodes, n = a.length, o = 0; o < n; ++o)
          ...
          s.subParser('makeMarkdown.pre', function (e, r) {
            'use strict';
            var t = e.getAttribute('prenum');
            return '<pre>' + r.preList[t] + '</pre>';
          }),
          s.subParser('makeMarkdown.strikethrough', function (e, r) {
            'use strict';
            var t = '';
            if (e.hasChildNodes()) {
              t += '~~';
          ...
          s.subParser('makeMarkdown.strong', function (e, r) {
            'use strict';
            var t = '';
            if (e.hasChildNodes()) {
              t += '**';
          ...
          s.subParser('makeMarkdown.table', function (e, r) {
            'use strict';
            var t,
              a,
              n = '',
            ...
            for (t = 0; t < i.length; ++t) {
              var c = s.subParser('makeMarkdown.tableCell')(i[t], r),
                u = '---';
            ...
            for (t = 0; t < l.length; ++t) {
              ...
              for (a = 0; a < i.length; ++a) {
                var h = ' ';
                void 0 !== p[a] &&
                  (h = s.subParser('makeMarkdown.tableCell')(p[a], r)),
                  o[d].push(h);
              }
            }
            var _ = 3;
            for (t = 0; t < o.length; ++t)
              for (a = 0; a < o[t].length; ++a) {
                var g = o[t][a].length;
                g > _ && (_ = g);
              }
            for (t = 0; t < o.length; ++t) {
              for (a = 0; a < o[t].length; ++a)
                1 === t
                  ? ':' === o[t][a].slice(-1)
                    ? (o[t][a] =
                        s.helper.padEnd(o[t][a].slice(-1), _ - 1, '-') + ':')
                    : (o[t][a] = s.helper.padEnd(o[t][a], _, '-'))
                  : (o[t][a] = s.helper.padEnd(o[t][a], _));
              n += '| ' + o[t].join(' | ') + ' |\n';
            }
            return n.trim();
          }),
          s.subParser('makeMarkdown.tableCell', function (e, r) {
            'use strict';
            var t = '';
            if (!e.hasChildNodes()) return '';
            for (var a = e.childNodes, n = a.length, o = 0; o < n; ++o)
              t += s.subParser('makeMarkdown.node')(a[o], r, !0);
            return t.trim();
          }),
          s.subParser('makeMarkdown.txt', function (e) {
            ...
            return (
              ...
              (r = (r = (r = (r = (r = (r = (r = (r =
                s.helper.unescapeHTMLEntities(r)).replace(
                /([*_~|`])/g,
                '\\$1'
