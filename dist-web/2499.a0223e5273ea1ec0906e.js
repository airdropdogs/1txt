/*! For license information please see 2499.a0223e5273ea1ec0906e.js.LICENSE.txt */
'use strict';
(self.webpackChunk = self.webpackChunk || []).push([
  [2499],
  {
    52499: (e, t, n) => {
      n.r(t),
        n.d(t, {
          CompletionAdapter: () => gt,
          DefinitionAdapter: () => Ct,
          DiagnosticsAdapter: () => ut,
          DocumentColorAdapter: () => jt,
          DocumentFormattingEditProvider: () => Rt,
          DocumentHighlightAdapter: () => _t,
          DocumentLinkAdapter: () => Tt,
          DocumentRangeFormattingEditProvider: () => Dt,
          DocumentSymbolAdapter: () => xt,
          FoldingRangeAdapter: () => Lt,
          HoverAdapter: () => vt,
          ReferenceAdapter: () => Et,
          RenameAdapter: () => At,
          SelectionRangeAdapter: () => Ft,
          WorkerManager: () => oe,
          fromPosition: () => lt,
          fromRange: () => ht,
          getWorker: () => tn,
      ...
      ((g = d || (d = {})).MIN_VALUE = -2147483648),
        (g.MAX_VALUE = 2147483647),
        ((h = l || (l = {})).MIN_VALUE = 0),
        (h.MAX_VALUE = 2147483647),
        ((p = f || (f = {})).create = function (e, t) {
          return (
            e === Number.MAX_VALUE && (e = l.MAX_VALUE),
        ...
        (p.is = function (e) {
          ...
          return (
            ot.objectLiteral(t) &&
            ot.uinteger(t.line) &&
            ot.uinteger(t.character)
          );
        }),
        ((v = m || (m = {})).create = function (e, t, n, r) {
          if (
            ot.uinteger(e) &&
            ot.uinteger(t) &&
            ot.uinteger(n) &&
            ...
            return { start: f.create(e, t), end: f.create(n, r) };
          if (f.is(e) && f.is(t)) return { start: e, end: t };
          throw new Error(
        ...
        (v.is = function (e) {
          var t = e;
          return ot.objectLiteral(t) && f.is(t.start) && f.is(t.end);
        }),
        ...
        (b.is = function (e) {
          ...
          return (
            ot.defined(t) &&
            m.is(t.range) &&
            (ot.string(t.uri) || ot.undefined(t.uri))
          );
        }),
        ...
        (w.is = function (e) {
          ...
          return (
            ot.defined(t) &&
            m.is(t.targetRange) &&
            ot.string(t.targetUri) &&
            (m.is(t.targetSelectionRange) ||
              ot.undefined(t.targetSelectionRange)) &&
            (m.is(t.originSelectionRange) ||
              ot.undefined(t.originSelectionRange))
          );
        }),
        ((y = C || (C = {})).create = function (e, t, n, r) {
          return { red: e, green: t, blue: n, alpha: r };
        }),
        (y.is = function (e) {
          var t = e;
          return (
            ot.numberRange(t.red, 0, 1) &&
            ot.numberRange(t.green, 0, 1) &&
            ot.numberRange(t.blue, 0, 1) &&
            ot.numberRange(t.alpha, 0, 1)
          );
        }),
        ((A = E || (E = {})).create = function (e, t) {
          return { range: e, color: t };
        }),
        (A.is = function (e) {
          var t = e;
          return m.is(t.range) && C.is(t.color);
        }),
        ((I = x || (x = {})).create = function (e, t, n) {
        ...
        (I.is = function (e) {
          ...
          return (
            ot.string(t.label) &&
            (ot.undefined(t.textEdit) || K.is(t)) &&
            (ot.undefined(t.additionalTextEdits) ||
              ot.typedArray(t.additionalTextEdits, K.is))
          );
        }),
        ((T = S || (S = {})).Comment = 'comment'),
        (T.Imports = 'imports'),
        (T.Region = 'region'),
        ((D = R || (R = {})).create = function (e, t, n, r, i) {
          var o = { startLine: e, endLine: t };
          return (
            ot.defined(n) && (o.startCharacter = n),
            ot.defined(r) && (o.endCharacter = r),
            ot.defined(i) && (o.kind = i),
            o
          );
        }),
        (D.is = function (e) {
          var t = e;
          return (
            ot.uinteger(t.startLine) &&
            ot.uinteger(t.startLine) &&
            (ot.undefined(t.startCharacter) || ot.uinteger(t.startCharacter)) &&
            (ot.undefined(t.endCharacter) || ot.uinteger(t.endCharacter)) &&
            (ot.undefined(t.kind) || ot.string(t.kind))
          );
        }),
        ...
        (M.is = function (e) {
          var t = e;
          return ot.defined(t) && k.is(t.location) && ot.string(t.message);
        }),
        ((L = j || (j = {})).Error = 1),
        (L.Warning = 2),
        (L.Information = 3),
        ...
        ((N || (N = {})).is = function (e) {
          var t = e;
          return null != t && ot.string(t.href);
        }),
        ((U = W || (W = {})).create = function (e, t, n, r, i, o) {
          var a = { range: e, message: t };
          return (
            ot.defined(n) && (a.severity = n),
            ot.defined(r) && (a.code = r),
            ot.defined(i) && (a.source = i),
            ot.defined(o) && (a.relatedInformation = o),
            a
          );
        }),
        (U.is = function (e) {
          ...
          return (
            ...
            m.is(n.range) &&
            ot.string(n.message) &&
            (ot.number(n.severity) || ot.undefined(n.severity)) &&
            (ot.integer(n.code) || ot.string(n.code) || ot.undefined(n.code)) &&
            (ot.undefined(n.codeDescription) ||
              ot.string(
                null === (t = n.codeDescription) || void 0 === t
                  ? void 0
                  : t.href
              )) &&
            (ot.string(n.source) || ot.undefined(n.source)) &&
            (ot.undefined(n.relatedInformation) ||
              ot.typedArray(n.relatedInformation, P.is))
          );
        }),
        ((H = V || (V = {})).create = function (e, t) {
          for (var n = [], r = 2; r < arguments.length; r++)
            n[r - 2] = arguments[r];
          var i = { title: e, command: t };
          return ot.defined(n) && n.length > 0 && (i.arguments = n), i;
        }),
        (H.is = function (e) {
          var t = e;
          return ot.defined(t) && ot.string(t.title) && ot.string(t.command);
        }),
        ((z = K || (K = {})).replace = function (e, t) {
          return { range: e, newText: t };
        }),
        (z.insert = function (e, t) {
        ...
        (z.is = function (e) {
          var t = e;
          return ot.objectLiteral(t) && ot.string(t.newText) && m.is(t.range);
        }),
        ((X = q || (q = {})).create = function (e, t, n) {
          var r = { label: e };
          return (
        ...
        (X.is = function (e) {
          ...
          return (
            ...
            ot.objectLiteral(t) &&
            ot.string(t.label) &&
            (ot.boolean(t.needsConfirmation) ||
              void 0 === t.needsConfirmation) &&
            (ot.string(t.description) || void 0 === t.description)
          );
        }),
        ((B || (B = {})).is = function (e) {
          return 'string' == typeof e;
        }),
        ((J = $ || ($ = {})).replace = function (e, t, n) {
        ...
        (J.is = function (e) {
          var t = e;
          return K.is(t) && (q.is(t.annotationId) || B.is(t.annotationId));
        }),
        ...
        (G.is = function (e) {
          var t = e;
          return (
            ot.defined(t) && de.is(t.textDocument) && Array.isArray(t.edits)
          );
        }),
        ((Z = Y || (Y = {})).create = function (e, t, n) {
          ...
          return (
            ...
            (void 0 === t.options ||
              ((void 0 === t.options.overwrite ||
                ot.boolean(t.options.overwrite)) &&
                (void 0 === t.options.ignoreIfExists ||
                  ot.boolean(t.options.ignoreIfExists)))) &&
            (void 0 === t.annotationId || B.is(t.annotationId))
          );
        }),
        ((te = ee || (ee = {})).create = function (e, t, n, r) {
          ...
          return (
            ...
            (void 0 === t.options ||
              ((void 0 === t.options.recursive ||
                ot.boolean(t.options.recursive)) &&
                (void 0 === t.options.ignoreIfNotExists ||
                  ot.boolean(t.options.ignoreIfNotExists)))) &&
            (void 0 === t.annotationId || B.is(t.annotationId))
          );
        }),
        ((ie || (ie = {})).is = function (e) {
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function (e) {
                return ot.string(e.kind)
                  ? Y.is(e) || ee.is(e) || ne.is(e)
                  : Q.is(e);
              }))
          );
        });
      ...
      !(function () {
          ...
          (this._textEditChanges = Object.create(null)),
            void 0 !== e
              ? ((this._workspaceEdit = e),
                e.documentChanges
                  ? ((this._changeAnnotations = new it(e.changeAnnotations)),
        ...
        Object.defineProperty(e.prototype, 'edit', {
            ...
            if (de.is(e)) {
              ...
              if (!(r = this._textEditChanges[t.uri])) {
                ...
                this._workspaceEdit.documentChanges.push(n),
                  (r = new rt(i, this._changeAnnotations)),
          ...
          (e.prototype.initDocumentChanges = function () {
            void 0 === this._workspaceEdit.documentChanges &&
              ...
              ((this._changeAnnotations = new it()),
          ...
          (e.prototype.createFile = function (e, t, n) {
            ...
            var r, i, o;
            if (
              (q.is(t) || B.is(t) ? (r = t) : (n = t),
              void 0 === r
                ? (i = Y.create(e, n))
                : ((o = B.is(r) ? r : this._changeAnnotations.manage(r)),
                  (i = Y.create(e, n, o))),
          ...
          (e.prototype.renameFile = function (e, t, n, r) {
            ...
            var i, o, a;
            if (
              (q.is(n) || B.is(n) ? (i = n) : (r = n),
              void 0 === i
                ? (o = ee.create(e, t, r))
                : ((a = B.is(i) ? i : this._changeAnnotations.manage(i)),
                  (o = ee.create(e, t, r, a))),
        ...
        ((se = ae || (ae = {})).create = function (e) {
          return { uri: e };
        }),
        (se.is = function (e) {
          var t = e;
          return ot.defined(t) && ot.string(t.uri);
        }),
        ((ue = ce || (ce = {})).create = function (e, t) {
          return { uri: e, version: t };
        }),
        (ue.is = function (e) {
          var t = e;
          return ot.defined(t) && ot.string(t.uri) && ot.integer(t.version);
        }),
        ...
        (ge.is = function (e) {
          ...
          return (
            ot.defined(t) &&
            ot.string(t.uri) &&
            (null === t.version || ot.integer(t.version))
          );
        }),
        ((he = le || (le = {})).create = function (e, t, n, r) {
        ...
        (he.is = function (e) {
          ...
          return (
            ot.defined(t) &&
            ot.string(t.uri) &&
            ot.string(t.languageId) &&
            ot.integer(t.version) &&
            ot.string(t.text)
          );
        }),
        ((pe = fe || (fe = {})).PlainText = 'plaintext'),
        (pe.Markdown = 'markdown'),
        (function (e) {
          e.is = function (t) {
            var n = t;
        ...
        ((me || (me = {})).is = function (e) {
          var t = e;
          return ot.objectLiteral(e) && fe.is(t.kind) && ot.string(t.value);
        }),
        ((ke = ve || (ve = {})).Text = 1),
        (ke.Method = 2),
        (ke.Function = 3),
        ...
        (ke.Operator = 24),
        (ke.TypeParameter = 25),
        ((_e = be || (be = {})).PlainText = 1),
        (_e.Snippet = 2),
        ((we || (we = {})).Deprecated = 1),
        ((ye = Ce || (Ce = {})).create = function (e, t, n) {
          return { newText: e, insert: t, replace: n };
        }),
        (ye.is = function (e) {
          var t = e;
          return t && ot.string(t.newText) && m.is(t.insert) && m.is(t.replace);
        }),
        ((Ae = Ee || (Ee = {})).asIs = 1),
        (Ae.adjustIndentation = 2),
        ((xe || (xe = {})).create = function (e) {
          return { label: e };
        }),
        ((Ie || (Ie = {})).create = function (e, t) {
          return { items: e || [], isIncomplete: !!t };
        }),
        ((Te = Se || (Se = {})).fromPlainText = function (e) {
        ...
        (Te.is = function (e) {
          ...
          return (
            ot.string(t) ||
            (ot.objectLiteral(t) && ot.string(t.language) && ot.string(t.value))
          );
        }),
        ((Re || (Re = {})).is = function (e) {
          var t = e;
          return (
            ...
            (me.is(t.contents) ||
              Se.is(t.contents) ||
              ot.typedArray(t.contents, Se.is)) &&
            (void 0 === e.range || m.is(e.range))
          );
        }),
        ...
        ((Pe || (Pe = {})).create = function (e, t) {
          ...
          var i = { label: e };
          return (
            ot.defined(t) && (i.documentation = t),
            ot.defined(n) ? (i.parameters = n) : (i.parameters = []),
            i
          );
        }),
        ((je = Me || (Me = {})).Text = 1),
        (je.Read = 2),
        (je.Write = 3),
        ((Le || (Le = {})).create = function (e, t) {
          var n = { range: e };
          return ot.number(t) && (n.kind = t), n;
        }),
        ((Oe = Fe || (Fe = {})).File = 1),
        (Oe.Module = 2),
        (Oe.Namespace = 3),
        ...
        (Ve.is = function (e) {
          ...
          return (
            ...
            (void 0 === t.detail || ot.string(t.detail)) &&
            (void 0 === t.deprecated || ot.boolean(t.deprecated)) &&
            (void 0 === t.children || Array.isArray(t.children)) &&
            (void 0 === t.tags || Array.isArray(t.tags))
          );
        }),
        ((Ke = He || (He = {})).Empty = ''),
        (Ke.QuickFix = 'quickfix'),
        (Ke.Refactor = 'refactor'),
        (Ke.RefactorExtract = 'refactor.extract'),
        (Ke.RefactorInline = 'refactor.inline'),
        (Ke.RefactorRewrite = 'refactor.rewrite'),
        (Ke.Source = 'source'),
        (Ke.SourceOrganizeImports = 'source.organizeImports'),
        (Ke.SourceFixAll = 'source.fixAll'),
        ((qe = ze || (ze = {})).create = function (e, t) {
          var n = { diagnostics: e };
        ...
        (qe.is = function (e) {
          ...
          return (
            ot.defined(t) &&
            ot.typedArray(t.diagnostics, W.is) &&
            (void 0 === t.only || ot.typedArray(t.only, ot.string))
          );
        }),
        ((Be = Xe || (Xe = {})).create = function (e, t, n) {
          var r = { title: e },
            i = !0;
          return (
            'string' == typeof t
        ...
        (Be.is = function (e) {
          ...
          return (
            t &&
            ot.string(t.title) &&
            (void 0 === t.diagnostics || ot.typedArray(t.diagnostics, W.is)) &&
            (void 0 === t.kind || ot.string(t.kind)) &&
            (void 0 !== t.edit || void 0 !== t.command) &&
            (void 0 === t.command || V.is(t.command)) &&
            (void 0 === t.isPreferred || ot.boolean(t.isPreferred)) &&
            (void 0 === t.edit || ie.is(t.edit))
          );
        }),
        ((Je = $e || ($e = {})).create = function (e, t) {
          var n = { range: e };
          return ot.defined(t) && (n.data = t), n;
        }),
        (Je.is = function (e) {
          var t = e;
          return (
            ot.defined(t) &&
            m.is(t.range) &&
            (ot.undefined(t.command) || V.is(t.command))
          );
        }),
        ...
        (Ge.is = function (e) {
          ...
          return (
            ot.defined(t) &&
            ot.uinteger(t.tabSize) &&
            ot.boolean(t.insertSpaces)
          );
        }),
        ((Ze = Ye || (Ye = {})).create = function (e, t, n) {
        ...
        (Ze.is = function (e) {
          ...
          return (
            ot.defined(t) &&
            m.is(t.range) &&
            (ot.undefined(t.target) || ot.string(t.target))
          );
        }),
        ((tt = et || (et = {})).create = function (e, t) {
        ...
        (tt.is = function (e) {
          ...
          return (
            void 0 !== t &&
            m.is(t.range) &&
            (void 0 === t.parent || tt.is(t.parent))
          );
        }),
        (function (e) {
          function t(e, n) {
          ...
          (e.create = function (e, t, n, r) {
            ...
            (e.is = function (e) {
              ...
              return !!(
                ot.defined(t) &&
                ot.string(t.uri) &&
                (ot.undefined(t.languageId) || ot.string(t.languageId)) &&
                ot.uinteger(t.lineCount) &&
                ot.func(t.getText) &&
                ot.func(t.positionAt) &&
                ot.func(t.offsetAt)
              );
            }),
          ...
          return (
            ...
            (e.prototype.positionAt = function (e) {
              ...
              var t = this.getLineOffsets(),
                n = 0,
                r = t.length;
              if (0 === r) return f.create(0, e);
              for (; n < r; ) {
                var i = Math.floor((n + r) / 2);
                t[i] > e ? (r = i) : (n = i + 1);
              }
              var o = n - 1;
              return f.create(o, e - t[o]);
            }),
      ...
      (at = ot || (ot = {})),
        ...
        (at.defined = function (e) {
          return void 0 !== e;
        }),
        (at.undefined = function (e) {
          return void 0 === e;
        }),
        ...
        (at.string = function (e) {
          return '[object String]' === st.call(e);
        }),
        (at.number = function (e) {
          return '[object Number]' === st.call(e);
        }),
        (at.numberRange = function (e, t, n) {
          return '[object Number]' === st.call(e) && t <= e && e <= n;
        }),
        (at.integer = function (e) {
          return (
            '[object Number]' === st.call(e) &&
            -2147483648 <= e &&
            e <= 2147483647
          );
        }),
        (at.uinteger = function (e) {
          return '[object Number]' === st.call(e) && 0 <= e && e <= 2147483647;
        }),
        (at.func = function (e) {
          return '[object Function]' === st.call(e);
        }),
        (at.objectLiteral = function (e) {
          return null !== e && 'object' == typeof e;
        }),
        (at.typedArray = function (e, t) {
      ...
      var gt = class {
        ...
        provideCompletionItems(e, t, n, r) {
          ...
          return this._worker(i)
            .then((e) => e.doComplete(i.toString(), lt(t)))
            .then((n) => {
              if (!n) return;
                ...
                o = n.items.map((e) => {
                  ...
                  return (
                    e.textEdit &&
                      ...
                      void 0 !== r.replace
                        ? (t.range = {
                            insert: ft(e.textEdit.insert),
                            replace: ft(e.textEdit.replace),
                          })
                        : (t.range = ft(e.textEdit.range)),
                      (t.insertText = e.textEdit.newText)),
                    e.additionalTextEdits &&
                      (t.additionalTextEdits = e.additionalTextEdits.map(mt)),
      ...
      function mt(e) {
        if (e) return { range: ft(e.range), text: e.newText };
      }
      var vt = class {
        constructor(e) {
          this._worker = e;
        ...
        provideHover(e, t, n) {
          ...
          return this._worker(r)
            .then((e) => e.doHover(r.toString(), lt(t)))
            .then((e) => {
              if (e) return { range: ft(e.range), contents: bt(e.contents) };
            });
        }
      };
      function kt(e) {
      ...
      var _t = class {
        ...
        provideDocumentHighlights(e, t, n) {
          const r = e.uri;
          return this._worker(r)
            .then((e) => e.findDocumentHighlights(r.toString(), lt(t)))
            .then((e) => {
              if (e)
                return e.map((e) => ({ range: ft(e.range), kind: wt(e.kind) }));
            });
        }
      };
      function wt(e) {
      ...
      var Ct = class {
        ...
        provideDefinition(e, t, n) {
          const r = e.uri;
          return this._worker(r)
            .then((e) => e.findDefinition(r.toString(), lt(t)))
            .then((e) => {
              if (e) return [yt(e)];
            });
        }
      ...
      function yt(e) {
        return { uri: u.Uri.parse(e.uri), range: ft(e.range) };
      }
      var Et = class {
          constructor(e) {
            this._worker = e;
          ...
          provideReferences(e, t, n, r) {
            const i = e.uri;
            return this._worker(i)
              .then((e) => e.findReferences(i.toString(), lt(t)))
              .then((e) => {
                if (e) return e.map(yt);
              });
          }
        },
        At = class {
          ...
          provideRenameEdits(e, t, n, r) {
            const i = e.uri;
            return this._worker(i)
              .then((e) => e.doRename(i.toString(), lt(t), n))
              .then((e) =>
                (function (e) {
                  ...
                  for (let n in e.changes) {
                    ...
                    for (let i of e.changes[n])
                      t.push({
                        resource: r,
                        versionId: void 0,
                        textEdit: { range: ft(i.range), text: i.newText },
                      });
                  }
                  return { edits: t };
                })(e)
                  ...
                  return e.map((e) =>
                    'children' in e
                      ...
                      : {
                          ...
                          kind: St(e.kind),
                          range: ft(e.location.range),
                          selectionRange: ft(e.location.range),
                          tags: [],
                        }
                  );
              });
      ...
      function It(e) {
        return {
          ...
          kind: St(e.kind),
          range: ft(e.range),
          selectionRange: ft(e.selectionRange),
          tags: e.tags ?? [],
          children: (e.children ?? []).map((e) => It(e)),
        };
      }
      function St(e) {
          ...
          provideDocumentFormattingEdits(e, t, n) {
            ...
            return this._worker(r).then((e) =>
              e.format(r.toString(), null, Pt(t)).then((e) => {
                if (e && 0 !== e.length) return e.map(mt);
              })
            );
          }
        },
        Dt = class {
          ...
          provideDocumentRangeFormattingEdits(e, t, n, r) {
            ...
            return this._worker(i).then((e) =>
              e.format(i.toString(), ht(t), Pt(n)).then((e) => {
                if (e && 0 !== e.length) return e.map(mt);
              })
            );
          }
      ...
      var Mt,
        jt = class {
          ...
          provideDocumentColors(e, t) {
            ...
            return this._worker(n)
              ...
              .then((e) => {
                if (e)
                  return e.map((e) => ({ color: e.color, range: ft(e.range) }));
              });
          }
          provideColorPresentations(e, t, n) {
            ...
            return this._worker(r)
              .then((e) =>
                e.getColorPresentations(r.toString(), t.color, ht(t.range))
              )
              .then((e) => {
                if (e)
                  return e.map((e) => {
                    let t = { label: e.label };
                    return (
                      e.textEdit && (t.textEdit = mt(e.textEdit)),
                      e.additionalTextEdits &&
                        (t.additionalTextEdits = e.additionalTextEdits.map(mt)),
                      t
                    );
        ...
        Ft = class {
          ...
          provideSelectionRanges(e, t, n) {
            const r = e.uri;
            return this._worker(r)
              .then((e) => e.getSelectionRanges(r.toString(), t.map(lt)))
              .then((e) => {
                if (e)
                  return e.map((e) => {
                    const t = [];
                    for (; e; ) t.push({ range: ft(e.range) }), (e = e.parent);
                    return t;
                  });
              });
          }
      ...
      (Mt || (Mt = {})).DEFAULT = { allowTrailingComma: !1 };
      var Ut = function (e, t) {
        void 0 === t && (t = !1);
        var n = e.length,
          r = 0,
          ...
          switch (t) {
            ...
            case 47:
              ...
              if (47 === e.charCodeAt(r + 1)) {
                for (r += 2; r < n && !Nt(e.charCodeAt(r)); ) r++;
            ...
            case 57:
              return (
                (i += (function () {
                  ...
                  else for (r++; r < e.length && Wt(e.charCodeAt(r)); ) r++;
                  if (r < e.length && 46 === e.charCodeAt(r)) {
                    if (!(++r < e.length && Wt(e.charCodeAt(r))))
                      return (g = 3), e.substring(t, r);
                    for (r++; r < e.length && Wt(e.charCodeAt(r)); ) r++;
                  }
                  var n = r;
                  if (
                    r < e.length &&
      ...
      var Vt,
        Ht = 'delimiter.bracket.json',
        Kt = 'delimiter.array.json',
        zt = 'delimiter.colon.json',
        ...
        Jt = 'number.json',
        Qt = 'string.key.json',
        Gt = 'comment.block.json',
        Yt = 'comment.line.json',
        Zt = class e {
          constructor(e, t) {
          ...
          equals(t) {
            return (
              ...
              (!!(t && t instanceof e) &&
                ...
                Zt.equals(this.parents, t.parents))
            );
          }
          getStateData() {
            return this._state;
      ...
      function tn() {
        return new Promise((e, t) => {
          if (!Vt) return t('JSON not registered!');
          e(Vt);
        });
      }
      ...
      function rn(e) {
        ...
        function i() {
          ...
          an(n),
            ...
            r.hovers &&
              n.push(u.languages.registerHoverProvider(t, new vt(Vt))),
            r.documentSymbols &&
              n.push(u.languages.registerDocumentSymbolProvider(t, new xt(Vt))),
            r.tokens &&
              n.push(
                u.languages.setTokensProvider(
                  t,
                  ((i = !0),
                  {
                      ...
                      (function (e, t, n, r = 0) {
                        ...
                        for (;;) {
                          ...
                          switch ((o && (d -= i), (o = i > 0), l)) {
                            case 1:
                              (c = Zt.push(c, 0)), (g = Ht), (s = !1);
                              break;
                            case 2:
                              (c = Zt.pop(c)), (g = Ht), (s = !1);
                              break;
                            case 3:
                              (c = Zt.push(c, 1)), (g = Kt), (s = !1);
                              break;
                            case 4:
                              (c = Zt.pop(c)), (g = Kt), (s = !1);
                              break;
            ...
            r.colors &&
              n.push(u.languages.registerColorProvider(t, new jt(Vt))),
            r.foldingRanges &&
              n.push(u.languages.registerFoldingRangeProvider(t, new Lt(Vt))),
            r.diagnostics && n.push(new nn(t, Vt, e)),
            r.selectionRanges &&
              n.push(u.languages.registerSelectionRangeProvider(t, new Ft(Vt)));
        }
        t.push(r),
          (Vt = (...e) => r.getLanguageServiceWorker(...e)),
          i(),
          t.push(u.languages.setLanguageConfiguration(e.languageId, sn));
        let o = e.modeConfiguration;
        return (
          e.onDidChange((e) => {
            e.modeConfiguration !== o && ((o = e.modeConfiguration), i());
          }),
          t.push(on(n)),
          on(t)
        );
